...
function LongabsentrestrictionCompletedManual({ isManualUser, handleAllowLogin }) {
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage
                ...
                .then((blob) => {
                    saveAs(blob, 'Long Absent Restriction Completed Manual List.png');
                })
                .catch((error) => {
    ...
    const handleprint = useReactToPrint({
        ...
        documentTitle: 'Long Absent Restriction Completed Manual List',
        pageStyle: 'print',
    });
    ...
    return (
        <Box>
                        ...
                        <>
                            <Box sx={userStyle.container}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={8}>
                                        <Typography sx={userStyle.SubHeaderText}>Long Absent Restriction Completed Manual List</Typography>
                                    </Grid>
                                    <Grid item xs={4}>
            ...
            <ExportData
                ...
                filename={'Long Absent Restriction Completed Manual List'}
...
export default LongabsentrestrictionCompletedManual;
