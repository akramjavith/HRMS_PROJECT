...
const HomeApprove = () => {
  ...
  const { isUserRoleAccess, isUserRoleCompare, listPageAccessMode, isAssignBranch } = useContext(UserRoleAccessContext);
  ...
  const fetchEmployee = async () => {
    ...
    try {
      let [res_prodhierarchy, res_longabsent, res_advance, res_loan, res_per, res_apl] = await Promise.all([
        ...
        isUserRoleCompare?.includes('lapprovals') && isUserRoleCompare?.includes('iteamleaveverification')
