...
function AllStockList() {
...

    {
      ...
      cellRenderer: (params) => (
        <Button
          ...
          style={{
            padding: '5px',
            backgroundColor: params.data.dbname === 'manualstocks' ? '#FFC300' : params.data.dbname === 'stocks' ? 'green' : 'blue',
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading title={`View Stock ${materialName} Details`} modulename="Asset" submodulename="Stock" mainpagename="All Stock Details" subpagename="" subsubpagename="" />
      {/* ****** Table Start ****** */}
        ...
        <>
          <Box sx={userStyle.container}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={8}>
                <Typography sx={userStyle.importheadtext}>{`View Stock ${materialName} Details`}</Typography>
              </Grid>
