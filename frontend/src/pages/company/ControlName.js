...
function ControlName() {
    ...
    const maxLength = 2;
    const [projectmaster, setProjectmaster] = useState({name: "",});
    const [isBtn, setIsBtn] = useState(false);
    const [projEdit, setProjedit] = useState({name: "",});
    ...
    const handleCaptureImage = () => {
        ...
        html2canvas(clonedTable).then((canvas) => {
            ...
            link.href = dataURL;
            link.download = "ControlName_Master.png";
            link.click();
        });
    };
    ...
    const rowData = async (id, name) => {
        ...
        try {
            let res = await axios.get(`${SERVICE.CONTROLNAME_SINGLE}/${id}`, {
                headers: {
    ...
    const delProject = async () => {
        setPageName(!pageName);
        try {
            await axios.delete(`${SERVICE.CONTROLNAME_SINGLE}/${projectid}`, {
                headers: {
                    'Authorization': `Bearer ${auth.APIToken}`
                }
            });
    ...
    const delProjectcheckbox = async () => {
        ...
        try {
            const deletePromises = selectedRows?.map((item) => {
                return axios.delete(`${SERVICE.CONTROLNAME_SINGLE}/${item}`, {
                    headers: {
                        'Authorization': `Bearer ${auth.APIToken}`
                    }
                });
    ...
    const sendRequest = async () => {
        ...
        setIsBtn(true)
        try {
            let projectscreate = await axios.post(SERVICE.CREATE_CONTROLNAME, {
                headers: {
                    'Authorization': `Bearer ${auth.APIToken}`
                },
    ...
    const getCode = async (e) => {
        ...
        try {
            ...
            let res = await axios.get(`${SERVICE.CONTROLNAME_SINGLE}/${e}`, {
                headers: {
                    'Authorization': `Bearer ${auth.APIToken}`
                }
            });
    ...
    const sendEditRequest = async () => {
        setPageName(!pageName);
        try {
            let res = await axios.put(`${SERVICE.CONTROLNAME_SINGLE}/${projectsid}`, {
                headers: {
                    'Authorization': `Bearer ${auth.APIToken}`
                },
    ...
    const fetchProjMaster = async () => {
        setPageName(!pageName);
        try {
            let res_project = await axios.get(SERVICE.ALL_CONTROLNAME, {
                headers: {
                    'Authorization': `Bearer ${auth.APIToken}`
                }
            });
    ...
    const handleExportXL = (isfilter) => {
        ...
        exportToExcel(formatData(dataToExport), 'ControlName');
        setIsFilterOpen(false);
    };
...

        {
            ...
            renderCell: (params) => (
                <Grid sx={{ display: "flex" }}>
                    {isUserRoleCompare?.includes("econtrolname") && (
                        <Button
                    ...
                    {isUserRoleCompare?.includes("dcontrolname") && (
                        <Button
                    ...
                    {isUserRoleCompare?.includes("vcontrolname") && (
                        <Button
                            sx={userStyle.buttonedit}
                            onClick={() => {
                    ...
                    {isUserRoleCompare?.includes("icontrolname") && (
                        <Button
                            sx={userStyle.buttonedit}
                            onClick={() => {
                                handleClickOpeninfo();
    ...
    return (
        <Box>
            ...
            {/* ****** Header Content ****** */}
            {/* <Typography sx={userStyle.HeaderText}>Control Name</Typography> */}
            <PageHeading
                title="Control Name"
                modulename="Setup"
                submodulename="Control Name"
                mainpagename=""
                subpagename=""
                subsubpagename=""
            />

            {isUserRoleCompare?.includes("acontrolname") && (
                <>
                                        ...
                                        <OutlinedInput
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (newValue.length <= maxLength) {
                                                    setProjectmaster({ ...projectmaster, name: newValue });
                                                }
                                            }}
                                        />
                                    </FormControl>
                                    ...
                                    <FormControl fullWidth size="small">
                                        ...
                                        <OutlinedInput
                                            ...
                                            onChange={(e) => {
                                                const newValue = e.target.value;
                                                if (newValue.length <= maxLength) {
                                                    setProjedit({ ...projEdit, name: newValue });
                                                }
                                            }}
                                        />
                                    </FormControl>
            ...
            <br />
            {/* ****** Table Start ****** */}
            {isUserRoleCompare?.includes("lcontrolname") && (
                <>
                    <Box sx={userStyle.container}>
                        {/* ******************************************************EXPORT Buttons****************************************************** */}
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>ControlName List</Typography>
                        </Grid>
                        ...
                        <Grid container spacing={2} style={userStyle.dataTablestyle}>
                            ...
                            <Grid item md={8} xs={12} sm={12} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                <Box >
                                    {isUserRoleCompare?.includes("excelcontrolname") && (
                                        <>
                                            <Button
                                                onClick={(e) => {
                                    ...
                                    {isUserRoleCompare?.includes("csvcontrolname") && (
                                        <>
                                            <Button
                                                onClick={(e) => {
                                                    setIsFilterOpen(true);
                                    ...
                                    {isUserRoleCompare?.includes("printcontrolname") && (
                                        <>
                                    ...
                                    {isUserRoleCompare?.includes("pdfcontrolname") && (
                                        <>
                                            <Button
                                                sx={userStyle.buttongrp}
                                                onClick={() => {
                        ...
                        {isUserRoleCompare?.includes("bdcontrolname") && (
              ...
              {/* this is info view details */}
                ...
                >
                    <Box sx={{ width: '550px', padding: '20px 50px' }}>
                        <>
                            <Typography sx={userStyle.HeaderText}>Control Name Info</Typography>
                            <br /><br />
                            <Grid container spacing={2}>
                                <Grid item md={12} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                ...
                <TableContainer component={Paper} style={{
                    ...
                    >
                        <TableHead>
                            <TableRow>
                                <TableCell> SI.No</TableCell>
                                <TableCell>ControlName</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody align="left">
                            {filteredData &&
            ...
            >
                <Box sx={{ width: "350px", padding: "20px 50px" }}>
                    <>
                        <Typography sx={userStyle.HeaderText}> View Control Name</Typography>
                        <br /> <br />
                        <Grid container spacing={2}>
                            <Grid item md={12} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
