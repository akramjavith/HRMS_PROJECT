...
function DocumentGrouping() {
    ...
    const { isUserRoleCompare, isUserRoleAccess, alldesignation } = useContext(UserRoleAccessContext);
    ...
    const fetchDocumentGrouping = async () => {
        ...
        } catch (err) {setDocumentgroupingcheck(true);handleApiError(err, setShowAlert, handleClickOpenerr);}
    }
