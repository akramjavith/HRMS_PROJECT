...
function Manuastockmaterial({ availqty, requestquantity,
    selectedPurchaseDateEdit, stockmanagemasteredit1,
    vendorGroupEdit, vendorOptEdit, locationsEdit,
    vendorNewEdit, refImagewarrantyedit, stockArray1,
    floorsEdit, areasEdit, vendorgetid, handleChangeGroupNameEdit, handleCloseviewalertvendormanualstock }) {
    ...
    const [setVendoroptEdit] = useState([]);
    ...
    const [stockArray, setStockArray] = useState(stockArray1);
    ...
    const getCode = async (e) => {
        try {
            ...
            console.log(res?.data?.smanualstock?.stockmaterialarray.totalbillamount, "tato")
    ...
    const [setLocationsEdit] = useState([
        { label: "ALL", value: "ALL" },
    ]);
    ...
    const editSubmit = async (e) => {
        ...
        else if ((stockmanagemasteredit.quantity > requestquantity) || (stockmanagemasteredit.quantity > availqty)) {
    ...
    const sendEditRequest = async () => {
        ...
        try {
            ...
            setPopupSeverity("success");
            handleClickOpenPopup();
            handleCloseviewalertvendormanualstock();
        } catch (err) {
            handleApiError(err, setPopupContentMalert, setPopupSeverityMalert, handleClickOpenPopupMalert);
        }
    };
        ...
        try {
            ...
            if (e === "Filtered") {
                ...
                const itemsWithSerialNumber = setData?.map((item, index) => {
                    ...
                    let totalbillamount = item.stockmaterialarray.map((data, newindex) => {
            ...
            <Box sx={{ padding: "20px 50px" }}>
                <>
                            ...
                            <FormControl fullWidth size="small">
                                ...
                                <OutlinedInput
                                    ...
                                    onChange={(e) => {
                                        ...
                                        // setAmountEdit(Number(e.target.value) * Number(stockmanagemasteredit.rate))
                                    }}
                                />
                            </FormControl>
                        </Grid>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <br />
                        <Grid item md={6} xs={12} sm={12}>
                            <Button sx={userStyle.btncancel} onClick={handleCloseviewalertvendormanualstock}>
                                {" "}
                                Cancel{" "}
                            </Button>
                        </Grid>
...
export default Manuastockmaterial;
