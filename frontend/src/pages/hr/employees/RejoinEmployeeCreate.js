...
function RejoinEmployeeCreate() {
  ...
  const { isUserRoleAccess, isUserRoleCompare, isAssignBranch, buttonStyles } = useContext(UserRoleAccessContext);
  // for attendance mode
  ...
  const fetchAccessibleDetails = async (eployeename, employeecode, newcompanyname, newempcode) => {
    try {
      ...
      if (allData?.length > 0) {
        ...
        let todos = allData
          ...
          ?.map((data) => ({
            ...
            branch: data?.branch,
            unit: data?.unit,
            employee: newcompanyname,
            employeecode: String(newempcode),
            id: data?._id,
        ...
        setAccessible({
          ...
          responsibleperson: newcompanyname,
          companycode: '',
          branchcode: '',
          unitcode: '',
          branchemail: '',
        ...
        if (Object.keys(newErrors).length === 0) {
          ...
          if (res?.data?.success) {
            ...
            async function checkCompanyName(employee) {
              ...
              // await fetchAccessibleDetails(
              //   employee.prevcompanyname,
              //   employee.prevempcode,
              //   response?.data?.uniqueCompanyName,
              //   newval
              // );
            }
            ...
            setNextBtnLoading(false);
            await filterCompanyDomain(employee?.company);
            nextStep(false);
          }
        }
      }
  ...
  const fetchareaNames = async (company, branch, floor) => {
    try {
  ...
  useEffect(() => {
    fetchUserDatas();
    allotWorkStation();
  }, [selectedBranch, selectedBranchstatus, selectedUnit, employee?.workmode, employee?.ifoffice]);
                  ...
                  <FormControl fullWidth size="small">
                    ...
                    <Selects
                      ...
                      onChange={(e) => {
                        ...
                        setEmployee({ ...employee, department: e.value, prod: e.prod, employeecount: '0', reportingto: '' });
                  ...
                  <Grid item md={4} sm={6} xs={12}>
                    <FormControl fullWidth size="small">
                      ...
                      <Selects
                        ...
                        onChange={(e) => {
                          fetchareaNames(selectedCompany, selectedBranch, e.value);
                          setEmployee({
                            ...employee,
                            floor: e.value,
                            area: '',
...
export default RejoinEmployeeCreate;
