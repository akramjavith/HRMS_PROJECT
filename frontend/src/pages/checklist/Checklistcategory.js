...
function Checklistcategory() {
  ...
  const { isUserRoleCompare, allProjects, isUserRoleAccess, pageName, setPageName } = useContext(
    ...
    if (isSubDuplicated) {
      ...
      setShowAlert(
        <>
          ...
          />
          <p style={{ fontSize: "20px", fontWeight: 900 }}>
            {"Subcategory Name is Filled. Please Insert!"}
          </p>
        </>
      );
      handleClickOpenerr();
  ...
  return (
    <Box>
      ...
      <PageHeading
        title="Manage Checklist Category"
          ...
          <Box sx={userStyle.container}>
            <Grid container spacing={2}>
              ...
              <Grid item md={12} sm={12} xs={12}>
                ...
                >
                  <LoadingButton variant="contained" loading={btnSubmit} onClick={handleSubmit}>
                    SAVE
                  </LoadingButton>
          ...
          <DialogContent>
            <Grid container spacing={2}>
              ...
              <Grid item md={12} sm={12} xs={12}>
                ...
                >
                  <LoadingButton loading={btnSubmitEdit} variant="contained" onClick={handleSubmitEdit}>
                    Update
                  </LoadingButton>
                  <Button
