...
function ReportCompanyOthertaskList() {
    ...
    const fetchEmployeeExports = async () => {
        setStatusCheck(false)
        setPageName(!pageName)
        console.time("fetchDataTimeExport");
        setIsLoading(true)
        ...
        try {
            let res_employee = await axios.post(SERVICE.ALL_OTHERTASKCOMPANY_SORT_EXPORT, queryParams, {
                headers: {
                    Authorization: `Bearer ${auth.APIToken}`,
                },
            ...
            console.timeEnd("fetchDataTimeExport");
            setIsLoading(false)
            setStatusCheck(true)
            // setSearchQuery("")
        } catch (err) {
                                    ...
                                    {isUserRoleCompare?.includes("excelcompanyothertaskreport") && (
                                        <>
                                            <LoadingButton
                                                ...
                                                sx={userStyle.buttongrp}><FaFileExcel />&ensp;Export to Excel&ensp;</LoadingButton>
                                        </>
                                    )}
                                    {isUserRoleCompare?.includes("csvcompanyothertaskreport") && (
                                        <>
                                            <LoadingButton onClick={(e) => {
                                                ...
                                                sx={userStyle.buttongrp}><FaFileCsv />&ensp;Export to CSV&ensp;</LoadingButton>
                                        </>
                                    )}
