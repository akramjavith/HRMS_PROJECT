...
function PenaltyErrorUpload() {
    ...
    const getviewCodeall = async (filename, data) => {
        ...
        try {
            ...
            let getFilenames = res?.data?.penaltyerroruploadpoints
    ...
    const exportColumnNames = ['From Date', 'To Date',
        // 'Project Vendor', 'Process',
        'File Name', 'Created By', 'Created Date & Time'];
    const exportRowValues = ['fromdate', 'todate',
                ...
                <Box sx={userStyle.selectcontainer}>
                    <>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item md={6} xs={12} sm={6}>
                                            <a
                                                              href={`/penalty/penaltyerrorexcel`}
                                                              target="_blank"
