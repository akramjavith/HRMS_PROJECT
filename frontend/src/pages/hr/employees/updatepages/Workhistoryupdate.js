...
import { Box, Button, Checkbox, Dialog, DialogActions, DialogContent, FormControl, FormGroup, Grid, IconButton, List, ListItem, ListItemText, MenuItem, OutlinedInput, Paper, Popover, Select, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Typography, Chip } from '@mui/material';
...
function EmpWorkHistory() {
  ...
  const getapi = async () => {
    let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
      ...
      pagename: String('Work History Update'),
  ...
  return (
    <Box>
      ...
      <PageHeading title="Work History Info update" modulename="Human Resources" submodulename="HR" mainpagename="Employee" subpagename="Employee Update Details" subsubpagename="Work History Info update" />
      {/* ****** Header Content ****** */}
      <br />
          ...
          {isUserRoleCompare?.includes('lworkhistoryinfoupdate') && (
            <>
              <Box sx={userStyle.container}>
                {/* ******************************************************EXPORT Buttons****************************************************** */}
                <Grid item xs={8}>
                  <Typography sx={userStyle.importheadtext}>Work History Update List</Typography>
                </Grid>
                <br />
                <Grid container spacing={2} style={userStyle.dataTablestyle}>
                  ...
                  >
                    <Box>
                      {isUserRoleCompare?.includes('excelworkhistoryinfoupdate') && (
                        <>
                          <Button
                            onClick={(e) => {
                      ...
                      {isUserRoleCompare?.includes('csvworkhistoryinfoupdate') && (
                        <>
                          <Button
                            onClick={(e) => {
                              setIsFilterOpen(true);
                      ...
                      {isUserRoleCompare?.includes('printworkhistoryinfoupdate') && (
                        <>
                      ...
                      {isUserRoleCompare?.includes('pdfworkhistoryinfoupdate') && (
                        <>
                          <Button
                            sx={userStyle.buttongrp}
                            onClick={() => {
                      ...
                      {isUserRoleCompare?.includes('imageworkhistoryinfoupdate') && (
          ...
          <Box>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item md={4} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      ...
                      <OutlinedInput id="component-outlined" type="text" value={empNameTodo} onChange={(e) => setEmpNameTodo(e.target.value)} />
                    </FormControl>
                  </Grid>
                  ...
                  <Grid item md={4} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      ...
                      <OutlinedInput
                        ...
                        value={leavedateTodo}
                        onChange={(e) => {
                          setLeavedateTodo(e.target.value);
                        }}
                        inputProps={{
                          min: joindateTodo, // Set the minimum date to the "Joined On" date
                        }}
                      />
                    </FormControl>
                  </Grid>
                        ...
                        {workhistTodo &&
                          workhistTodo.map((todo, index) => (
                            <StyledTableRow key={index}>
                              ...
                              <StyledTableCell align="center">{todo.joindateTodo ? moment(todo.joindateTodo, 'YYYY-MM-DD').format('DD-MM-YYYY') : ''}</StyledTableCell>
                              <StyledTableCell align="center">{todo.leavedateTodo ? moment(todo.leavedateTodo, 'YYYY-MM-DD').format('DD-MM-YYYY') : ''}</StyledTableCell>
            ...
            <Dialog open={openInfo} onClose={handleCloseinfo} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description" maxWidth="lg">
              <Box sx={{ width: '550px', padding: '20px' }}>
                <>
                  <Typography sx={userStyle.HeaderText}> Workhistory Info</Typography>
                  <br />
                  <br />
                  <Grid container spacing={2}>
