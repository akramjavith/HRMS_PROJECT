...
function AddQualificationupdate() {
  ...
  const handleExportXL = (isfilter) => {
    ...
    exportToExcel(
      ...
      "Additional Qualification Update List"
    );
    setIsFilterOpen(false);
  };
        ...
        <>
          {isUserRoleCompare.includes("Manager") ? (
              ...
              <Grid container spacing={2}>
                <Grid item>
                  {isUserRoleCompare?.includes(
                    "iadditionalqualificationupdate"
                  ) && (
                    <>
                      <Button
            ...
            <>
              <Grid sx={{ display: "flex" }}>
                {isUserRoleCompare?.includes(
                  "eadditionalqualificationupdate"
                ) && (
                  <Button
                    sx={userStyle.buttonedit}
                    onClick={() => {
  ...
  return (
    <Box>
      ...
      <PageHeading
        title="Manage Additional Qualification Update"
        modulename="Human Resources"
        submodulename="HR"
        mainpagename="Employee"
        subpagename="Employee Update Details"
        subsubpagename="Additional Qualification Update"
      />{" "}
      <br />
              ...
              <Box sx={userStyle.container}>
                ...
                <Grid container spacing={2} style={userStyle.dataTablestyle}>
                  ...
                  >
                    <Box>
                      {isUserRoleCompare?.includes(
                        "exceladditionalqualificationupdate"
                      ) && (
                        <>
                          <Button
                            onClick={(e) => {
                      ...
                      {isUserRoleCompare?.includes(
                        "csvadditionalqualificationupdate"
                      ) && (
                        <>
                          <Button
                            onClick={(e) => {
                      ...
                      {isUserRoleCompare?.includes(
                        "printadditionalqualificationupdate"
                      ) && (
                        <>
                          <Button
                            sx={userStyle.buttongrp}
                      ...
                      {isUserRoleCompare?.includes(
                        "pdfadditionalqualificationupdate"
                      ) && (
                        <>
                          <Button
                            sx={userStyle.buttongrp}
                      ...
                      {isUserRoleCompare?.includes(
                        "imageadditionalqualificationupdate"
                      ) && (
                        <Button
                          sx={userStyle.buttongrp}
          ...
          <Box>
            ...
            >
              <DialogContent sx={{ overflowY: "visible" }}>
                ...
                <Typography sx={userStyle.SubHeaderText}>
                  {" "}
                  Additional Qualification Update
                </Typography>
                <br />
                <br />
                <br />
                            ...
                            <StyledTableCell align="center">
                              {
                                <Button
                                  ...
                                  color="error"
                                  type="button"
                                  onClick={() => handleAddQualDelete(index)}
                                  sx={userStyle.Todoadd}
                                >
                                  <AiOutlineClose />
                                </Button>
