...
import {
  Box, Typography, Select, MenuItem, Dialog, DialogContent, DialogActions, FormControl, Grid,
...
function Typegroupmaster() {
  ...
  const fetchTypemaster = async () => {
    ...
    try {
      ...
      setTypemasters(res_vendor?.data?.typemasters.map((item, index) => ({
  ...
  return (
    <Box>
      ...
      <PageHeading
        ...
        mainpagename="Type Group Master"
        subpagename=""
        subsubpagename=""
      />
      ...
      <InfoPopup
        ...
        heading="Type Group Master Info"
        addedby={addedby}
        updateby={updateby}
      />
