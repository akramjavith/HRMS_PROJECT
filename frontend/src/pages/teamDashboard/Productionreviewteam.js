...
import { Box, Typography, OutlinedInput, Select, Paper, MenuItem, Dialog, DialogContent, DialogActions, FormControl, Grid, Button, List, ListItem, ListItemText, Popover, Checkbox, TextField, IconButton } from '@mui/material';
...
function ListProductionPoints() {
  ...
  const { isUserRoleCompare, listPageAccessMode,isUserRoleAccess, isAssignBranch, allCompany, allBranch, allUnit, allTeam } = useContext(UserRoleAccessContext);
  ...
  let exportColumnNames =
    pointsFilter.fromdate === pointsFilter.todate
      ? ['Employee Code', 'Employee Name', 'Company', 'Branch', 'Unit', 'Team', 'From Date', 'To Date', 'Min Points', 'Exp', 'Target', 'Target Total', 'Point', 'Avg Point', 'Min Diff', 'Tar Diff', 'Min Reached', 'Status', 'Day Status']
      : ['Employee Code', 'Employee Name', 'Company', 'Branch', 'Unit', 'Team', 'From Date', 'To Date', 'Min Points', 'Exp', 'Target', 'Target Total', 'Point', 'Avg Point', 'Min Diff', 'Tar Diff', 'Min Reached', 'Status'];

  let exportRowValues =
    pointsFilter.fromdate === pointsFilter.todate
      ? ['empcode', 'name', 'companyname', 'branch', 'unit', 'team', 'startDate', 'endDate', 'daypoint', 'experience', 'targetsingle', 'target', 'point', 'avgpoint', 'mindiff', 'tardiff', 'minreached', 'status', 'daystatus']
      : ['empcode', 'name', 'companyname', 'branch', 'unit', 'team', 'startDate', 'endDate', 'daypoint', 'experience', 'targetsingle', 'target', 'point', 'avgpoint', 'mindiff', 'tardiff', 'minreached', 'status'];
          ...
          <Grid item md={2.5} sm={6} lg={2.5} xs={12}>
            ...
            <FormControl fullWidth size="small">
              <OutlinedInput
                ...
                // Set the max attribute to the current date
                inputProps={{ max: new Date(serverTime).toISOString().split('T')[0], min: pointsFilter.fromdate !== '' ? pointsFilter.fromdate : null }}
              />
            </FormControl>
          </Grid>
