...
function Erroruploadconfirmuserlist() {
    ...
    const tableOptions = [
        { label: "Error Upload Confirm User List List", value: "Error Upload Confirm User List List" },
    ...
    const exportColumnNames = [
        ...
        'Project Vendor', 'Date',
        'Queue Name', 'Login ID',
        'Accuracy', 'Total Fields', 'Error Count', 'Auto Count', 'Manual Total', 'Manual Error', 'Upload Count',
    ]
    const exportRowValues = [
        'companyname', 'branchname', 'unitname',
        'projectvendor', 'date',
        'queuename', 'loginid',
        'accuracy', 'totalfields', 'errorcount', 'autocount', 'manualtotal', 'manualerror', 'Manual Error', 'uploadcount'
    ]
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "Error Upload Confirm User List.png");
                })
                .catch((error) => {
    ...
    let listpageaccessby =
        listPageAccessMode?.find(
            (data) =>
                ...
                data.subsubpagename === "Error Upload Confirm User List"
    ...
    const fetchBatchFilter = async () => {
        ...
        try {
            let res_employee = await axios.post(
                    SERVICE.ERROR_UPLOAD_CONFIRM_USER_LIST,
                    {
                        headers: {
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("Error Upload Confirm User List"),
    ...
    return (
        <Box>
            {/* <Headtitle title={"Error Upload Confirm User List"} /> */}
            {/* ****** Header Content ****** */}
            <PageHeading
                title="Error Upload Confirm User List"
                modulename="Quality"
                submodulename="Penalty"
                mainpagename="Penalty Setup"
                subpagename="Penalty Calculation"
                subsubpagename="Error Upload Confirm User List"
            />
            <Box>
                ...
                <br />
                    ...
                    <>
                        ...
                        <Box sx={userStyle.dialogbox}>
                            <>
                                <Grid item xs={8}>
                                    <Typography sx={userStyle.importheadtext}>Error Upload Confirm User List List</Typography>
                                </Grid>
                                    ...
                                    >
                                        <Box>
                                            {isUserRoleCompare?.includes(
                                                "excelerroruploadconfirmuserlist"
                                            ) && (
                                                    <>
                                                        <Button
                                                            onClick={(e) => {
                                            ...
                                            {isUserRoleCompare?.includes(
                                                "printerroruploadconfirmuserlist"
                                            ) && (
                                                    <>
                                            ...
                                            {isUserRoleCompare?.includes(
                                                "imageerroruploadconfirmuserlist"
                                            ) && (
                                                    <Button
                                                        sx={userStyle.buttongrp}
            ...
            <ExportData
                ...
                itemsTwo={isuser ?? []}
                filename={"Error Upload Confirm User List_List"}
