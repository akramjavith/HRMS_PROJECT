...
function TaskUserNonScheduleLog() {
    ...
    const downloadPdf = (isfilter) => {
        ...
        doc.save("TaskNonScheduleGroupinglog.pdf");
    };
    ...
    const fetchTaskGrouping = async () => {
        try {
            ...
            setTaskGroupingArray(res_freq?.data?.taskforuser);
            setLoader(true);
    ...
    const handleCaptureImage = () => {
        if (gridRef.current) {
            html2canvas(gridRef.current).then((canvas) => {
                canvas.toBlob((blob) => {
                    saveAs(blob, "TaskNonScheduleGroupinglog.png");
                });
            });
        }
    };
    ...
    // Excel
    const fileName = "TaskNonScheduleGroupinglog";
    ...
    const handleprint = useReactToPrint({
        ...
        documentTitle: "Task Schedule Grouping Log",
        pageStyle: "print",
    });
    ...
    return (
        <Box>
            ...
            {/* ****** Header Content ****** */}
            <Typography sx={userStyle.HeaderText}>Manage Task Non-Schedule Log</Typography>
