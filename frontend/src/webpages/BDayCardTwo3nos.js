                ...
                <div id="birthday-cardtwo3nos">
                    ...
                    <div id="emponediv">
                        <div id="profileImgtwo3nos" >
                            ...
                            >{employeeOneDob === "" ? "" : moment(employeeOneDob)?.format("DD-MM-YYYY")}</span>
                        </div>
                    ...
                    <div id="emptwodiv">
                        <div id="profileImgtwotwo3nos" >
                            ...
                            >{employeeTwoDob === "" ? "" : moment(employeeTwoDob)?.format("DD-MM-YYYY")}</span>
                        </div>
                    ...
                    <div id="emptwodiv">
                        <div id="profileImgtwothree3nos" >
                            ...
                            >{employeeThreeDob === "" ? "" : moment(employeeThreeDob)?.format("DD-MM-YYYY")}</span>
                        </div>
