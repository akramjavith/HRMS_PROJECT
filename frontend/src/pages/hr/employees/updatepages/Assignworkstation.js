...
function AssignWorkStation() {
    ...
    const aggregationPipeline = [
      {
        $match: {
          $and: [
            ...
            {
              $or: [
                { workstation: { $exists: false } }, // Handle documents where 'workstation' field does not exist
                { workstation: { $size: 0 } }, // Handle documents where 'workstation' is an empty array
                { workstation: "Please Select Primary Work Station" }, // Handle documents where 'workstation' contains the specified string
              ],
            },
          ],
        },
  ...
  return (
    <Box>
      ...
      <PageHeading
        title="Manage UnAssigned Employee Work Station"
