...
function Enquiryview() {
  ...
  const fetchHandlerEdit = async () => {
    try {
      const [response, responsenew] = await Promise.all([
                ...
                {employee.shifttype === "Standard" ? (
                  <>
                    <Grid item md={4} sm={6} xs={12}>
                      ...
                      <FormControl fullWidth size="small">
                        <OutlinedInput
                          value={employee?.boardingLog[0]?.shiftgrouping}
                          readOnly={true}
                        />
                      </FormControl>
                    </Grid>
                    <Grid item md={4} sm={6} xs={12}>
                      ...
                      <FormControl fullWidth size="small">
                        <OutlinedInput
                          value={employee?.boardingLog[0]?.shifttiming}
                          readOnly={true}
                        />
                      </FormControl>
                    </Grid>
