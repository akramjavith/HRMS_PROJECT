...
const MyRolesAndResponsiblities = React.lazy(() => import('../pages/hr/MyRolesandResponsiblities'));
const RolesAndResponsiblities = React.lazy(() => import('../pages/hr/RolesAndResponsiblities'));
...
const EmployeefacilityReport = React.lazy(() => import("../pages/hr/employees/Employeefacilityreport.js"));
const EmployeefacilityreportLog = React.lazy(() => import("../pages/hr/employees/EmployeefacilityreportLog.js"));
...
const IndividualUserShiftWeekOffPresent = React.lazy(() => import("../pages/hr/shiftroaster/IndividualUsershiftweekoffpresent.js"));
const IndividualUserShiftWeekOffPresentPreviousLogList = React.lazy(() => import("../pages/hr/shiftroaster/IndividualUsershiftweekoffpresentpreviousloglist.js"));
...
const AddVisitorsIn = React.lazy(() => import("../pages/interactors/visitors/AddVisitorin"));
...
const Penaltyoverallreport = React.lazy(() => import("../pages/production/penalty/Penaltyoverallreport"));
...
const BiometricReport = React.lazy(() => import("../pages/hr/employees/updatepages/BiometricAttendanceReport.js"));
...
const OtherTaskConsolidatedReportSummary = React.lazy(() => import("../pages/othertask/OtherTaskConsolidatedSummary.js"));
...
const LimitControlSetting = React.lazy(() => import("../pages/settings/Limitcontrolsetting.js"));
const LimitControlSettingLoglist = React.lazy(() => import("../pages/settings/Limitcontrolsettingloglist.js"));

///Download PDF
const CompressPdf = React.lazy(() => import("../pages/Downloadfile/Compresspdf"));
const MergePdf = React.lazy(() => import("../pages/Downloadfile/MergePdf"));
const ViewPdf = React.lazy(() => import("../pages/Downloadfile/Viewpdf"));
const SplitPdf = React.lazy(() => import("../pages/Downloadfile/SplitPdf"));
const OrganizedPdf = React.lazy(() => import("../pages/Downloadfile/Organized"));
const ExcelToPdf = React.lazy(() => import("../pages/Downloadfile/ExceltoPdf"));
const JpgToPdfConverter = React.lazy(() => import("../pages/Downloadfile/jpgtoPdf"));
const StockReorder = React.lazy(() => import("../pages/stockpurchase/stockreorder"));
const OrganizationalUnitGrouping = React.lazy(() => import("../pages/LDAP/OrganizationalUnitGrouping"));

const LDAPsetting = React.lazy(() => import("../pages/LDAP/LDAPsetting"));
const OrganizationalUnit = React.lazy(() => import("../pages/LDAP/OrganizationalUnit"));

const InterviewRoundsTestVerification = React.lazy(() => import("../pages/interview/InterviewRoundsTestVerification"));
const InterviewRoundsTestVerificationResults = React.lazy(() => import("../pages/interview/InterviewRoundsTestVerificationResults"));
const TeamShiftVerification = React.lazy(() => import("../pages/hr/shiftroaster/TeamShiftVerification.js"));
...
const LockedUsersList = React.lazy(() => import("../pages/LDAP/LockedUsersList.js"));
const DisabledUsersList = React.lazy(() => import("../pages/LDAP/DisabledUsersList.js"));
const DomainUsersList = React.lazy(() => import("../pages/LDAP/DomainUsersList.js"));
const Biometricbrandmodel = React.lazy(() => import('../pages/biometric/Biometricbrandmodel'));
const BiometricDeviceMaster = React.lazy(() => import('../pages/biometric/BiometricDeviceMaster'));

//15.04.2025
const NoticeperiodScheduledMeetinglist = React.lazy(() => import("../pages/hr/noticeperiod/NotificationDataShown.js"));
...
const Erroruploadconfirmlist = React.lazy(() => import("../pages/production/penalty/Erroruploadconfirmuserlist.js"));


const EsiFormulaMaster = React.lazy(() => import("../pages/company/esiformulamaster.js"));

const SalaryPfMaster = React.lazy(() => import("../pages/company/salarypfmaster.js"));
const InvalidValidOverallReport = React.lazy(() => import("../pages/production/penalty/invalidvalidoverallreport.js"));
const StockmanagerequestGetId = React.lazy(() => import("../pages/stockpurchase/stockrequestgetid.js"));
...
const Idleworkstatus = React.lazy(() => import('../pages/production/nonproduction/idleworkstatus.js'));
const IndividualIdleworkstatus = React.lazy(() => import('../pages/production/nonproduction/individualidleworkstatus.js'));
const TeamListNonproduction = React.lazy(() => import('../pages/production/nonproduction/TeamListnonproduction.js'));
      ...
      <Suspense fallback={<Loading />}>
        ...
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route path="interview/interviewroundstestverification" element={<InterviewRoundsTestVerification />} />
            <Route path="interview/interviewroundstestverificationresults" element={<InterviewRoundsTestVerificationResults />} />
            ...
            <Route path="employeefacilityreport" element={<EmployeefacilityReport />} />
            <Route path="/employeefacilityreportlog/:logid" element={<EmployeefacilityreportLog />} />
            ...
            <Route path="/expense/paymentduereminderlog" element={<PaymentDueReminderLog />} />
            ...
            <Route path="attendance/individualusershiftweekoffpresent" element={<IndividualUserShiftWeekOffPresent />} />
            <Route path="attendance/previousloglist/:id" element={<IndividualUserShiftWeekOffPresentPreviousLogList />} />
            ...
            <Route path="/recruitment/addresume/:id/:status" element={<Addresumeinteractor />} />
            ...
            <Route path="settings/payslipone/:month/:year/:id/:sealid/:signatureid/:backgroundid/:genby/:gendate/:qrcode" element={<Payslip />} />
            <Route path="settings/paysliptwo/:month/:year/:id/:sealid/:signatureid/:backgroundid/:genby/:gendate/:qrcode" element={<PayslipTemplateTwo />} />
            <Route path="settings/payslipthree/:month/:year/:id/:sealid/:signatureid/:backgroundid/:genby/:gendate/:qrcode" element={<Payslipthree />} />
            ...
            <Route path="production/penaltyoverallreport" element={<Penaltyoverallreport />} />
            ...
            <Route path="/employeestatus/biometricattendancereport" element={<BiometricReport />} />
            ...
            <Route path="production/othertaskconsolidatedreportsummary" element={<OtherTaskConsolidatedReportSummary />} />
            ...
            <Route path="/interactor/addvisitorin" element={<AddVisitorsIn />} />
            ...
            <Route path="settings/limitcontrolsetting" element={<LimitControlSetting />} />
            <Route path="settings/limitcontrolsettingloglist/:id" element={<LimitControlSettingLoglist />} />

            <Route path="stockpurchase/stockreorder" element={<StockReorder />} />
            <Route path="interactor/master/visitorenquiery" element={<VisitorEnquiery />} />

            <Route path="ldap/ldapsetting" element={<LDAPsetting />} />
            <Route path="ldap/organizationalunit" element={<OrganizationalUnit />} />
            ...
            <Route path="/organizedpdf" element={<OrganizedPdf />} />
            <Route path="/exceltopdf" element={<ExcelToPdf />} />
            <Route path="/jpgtopdf" element={<JpgToPdfConverter />} />
            <Route path="ldap/organizationalunitgrouping" element={<OrganizationalUnitGrouping />} />
            <Route path="interactor/master/requestvisitorfollowup" element={<RequestVisitorFollowupFilter />} />
            <Route path="/teamshiftverification" element={<TeamShiftVerification />} />
            ...
            <Route path="/ldap/lockeduserslist" element={<LockedUsersList />} />
            <Route path="/ldap/disableduserslist" element={<DisabledUsersList />} />
            <Route path="/ldap/domainuserslist" element={<DomainUsersList />} />
            ...
            <Route path="/biometric/biometricdevicemaster" element={<BiometricDeviceMaster />} />

            <Route path="/updatepages/noticeperiodscheduledmeetinglist" element={<NoticeperiodScheduledMeetinglist />} />

            <Route path="/updatepages/pendingreleaveexitlist" element={<PendingReleaveExitList />} />

            <Route path="employeedesignationrequirements" element={<RolesAndResponsiblities />} />
            <Route path="myrolesandresponsibilities" element={<MyRolesAndResponsiblities />} />

            <Route path="assetspecification/hardwarespecification" element={<HardwareSpecification />} />
            <Route path="production/erroruploadconfirmlist" element={<Erroruploadconfirmlist />} />
            <Route path="esiformulamaster" element={<EsiFormulaMaster />} />
            <Route path="salarypfmaster" element={<SalaryPfMaster />} />
            <Route path="production/penalty/invalidvalidoverallreport" element={<InvalidValidOverallReport />} />
...
{/* my dashboard */}
              ...
              <Route path="eventslisthometeam" element={<EventsListHomeTeam />} />
                ...
                <Route path="nonproduction/idleworkstatus" element={<Idleworkstatus />} />
                <Route path="nonproduction/individualidleworkstatus" element={<IndividualIdleworkstatus />} />
                <Route path="nonproduction/teamlistnonproduction" element={<TeamListNonproduction />} />
