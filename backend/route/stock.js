...
const { getAllStock, getAllStockAccess, addStock, getSingleStock, getOverallStockTableSort,
    ...
    getAllStockReorderFetch,getAllStockManagementStatus,getAllStockManagementStatusManual,getAllStockPurchaseLimitedAssign
...
stockRoute.route("/stockpurchaselimitedassign").get(getAllStockPurchaseLimitedAssign)
...
const { getAllManualstock, addManualstock, getSingleManualstock, getAllManualstockAccess, getAllManualstockAccessStock, getAllManualstockLimited,
    ...
    updateManualstock, deleteManualstock, Manualstocktrasnferfilter,uploadChunkManual,getAllManualTodoDelete,getAllManualTodoEditFetch } = require("../controller/modules/stockpurchase/manualstockentry");
stockRoute.route("/manualstocks").get(getAllManualstock);

stockRoute.route("/uploadchunkmanual").post(uploadChunkManual);
stockRoute.route("/manualtododelete").post(getAllManualTodoDelete);
stockRoute.route("/manualtodoeditfetch").post(getAllManualTodoEditFetch);
