...
function ClientErrorWaiverApproval() {
    ...
    return (
        <Box>
            ...
            />
            {isUserRoleCompare?.includes("aclienterrorwaiverapproval") && (
                <>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={8}>
                                    <Typography sx={userStyle.importheadtext}>
                                        Add Client Error Waiver Approval
                                    </Typography>
                                </Grid>
                            </Grid>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item md={12} xs={12} sm={12}>
                                        <Typography sx={userStyle.HeaderText}>
                                            Edit Client Error Waiver Approval
                                        </Typography>
                                    </Grid>
                                </Grid>
                                <br />
            ...
            {isUserRoleCompare?.includes("lclienterrorwaiverapproval") && (
                ...
                <>
                    <Box sx={userStyle.container}>
                        ...
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>
                            {/* Client Error Waiver Approval List */}
                                 Approved Employee Client Error Waiver Request List
                            </Typography>
                        </Grid>
                ...
                <>
                    <Box sx={userStyle.container}>
                        ...
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>
                            {/* Client Error Waiver Approval List */}
                                  Reject Employee Client Error Waiver Request List
                            </Typography>
                        </Grid>
                        <Grid container spacing={2} style={userStyle.dataTablestyle}>
                            <Grid item md={2} xs={12} sm={12}>
            ...
            <br />
            <ResentEmployeeClient />
            <br />
            <WaitRecheckEmployeeClient />
            ...
            >
                <Box sx={{ width: "550px", padding: "20px 50px" }}>
                    <>
                        <Typography sx={userStyle.HeaderText}> View Client Error Waiver Approval</Typography>
                        <br /> <br />
                        <Grid container spacing={2}>
                            <Grid item md={12} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
            ...
            <ExportData
                ...
                filename={"Approved Employee Client Error Waiver Request "}
            ...
            <ExportData
                ...
                filename={"Reject Employee Client Error Waiver Request"}
            ...
            <InfoPopup
                ...
                heading="Client Error Waiver Approval Info"
                addedby={addedby}
                updateby={updateby}
            />
