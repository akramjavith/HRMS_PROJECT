...
function TempControlPanel() {
    ...
    const { isUserRoleCompare, isUserRoleAccess, isAssignBranch, allUsersData, allTeam, pageName,
        setPageName,
            ...
            renderCell: (params) => (
                <Grid sx={{ display: 'flex' }}>
                    {isUserRoleCompare?.includes("etemplatecontrolpanel") && (
                        <Button onClick={() => { getCodeEdit(params.row.id) }}>Change</Button>
                    )}
                    {isUserRoleCompare?.includes("dtemplatecontrolpanel") && (
                        <Button sx={userStyle.buttondelete} onClick={(e) => { rowData(params.row.id) }}><DeleteOutlineOutlinedIcon sx={buttonStyles.buttondelete} style={{ fontsize: 'large' }} /></Button>
                    )}
        ...
        <Box>
                    ...
                    <>
                        ...
                        <Box sx={userStyle.dialogbox}>
                            <>
                                        ...
                                        <Grid item md={4} sm={12} xs={12}>
                                            ...
                                            <div>
                                                <Button
                                                    ...
                                                    size="small"
                                                    component="label"
                                                    sx={{ ...buttonStyles.buttonsubmit, "@media only screen and (max-width:550px)": { marginY: "5px" } }}
                                                    onClick={handleClick}
                                                >
                                                    Upload
                                                </Button>
                                    ...
                                    <Grid container spacing={1}>
                                        ...
                                        <Grid item md={12} xs={12} sm={12}>
                                            {todoscheckToCompany?.length > 0 &&
                                                <ul type="none">
                                                    {todoscheckToCompany?.length > 0 && <Typography> <b>Todo : </b></Typography>}
                                                                    ...
                                                                    <Grid item md={4} xs={12} sm={12}>
                                                                        <FormControl fullWidth size="small">
                                                                            <OutlinedInput
                                                                                ...
                                                                                placeholder="Please Enter CC address"
                                                                                value={ccEmailCreate}
                                                                                onChange={(e) => setCcEmailCreate(e.target.value)}
                                                                            />
                                                                        </FormControl>
                                                                    </Grid>
                                                                </>
                                                                    ...
                                                                    <Grid item md={4} xs={12} sm={12}>
                                                                        <FormControl fullWidth size="small">
                                                                            <OutlinedInput
                                                                                ...
                                                                                onChange={(e) => setBccEmailCreate(e.target.value)}
                                                                            />
                                                                        </FormControl>
                                                                    </Grid>
                                                                </>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item md={2} xs={12} sm={6}>
                                        <LoadingButton sx={buttonStyles.buttonsubmit} loading={btnSubmit} variant='contained' color='primary' onClick={handleSubmit} disabled={isActive}>Submit</LoadingButton>
                            ...
                            <form onSubmit={editSubmit}>
                                        ...
                                        <Grid container spacing={1}>
                                            ...
                                            <Grid item md={12} xs={12} sm={12}>
                                                {todoscheckToCompanyEdit?.length > 0 &&
                                                    <ul type="none">
                                                        {todoscheckToCompanyEdit?.length > 0 &&
                                                            <Typography> <b>Todo : </b></Typography>}
                                                                    ...
                                                                    <Grid item md={4} xs={12} sm={12}>
                                                                        <FormControl fullWidth size="small">
                                                                            <OutlinedInput
                                                                                ...
                                                                                onChange={(e) => setCcEmailCreateEdit(e.target.value)}
                                                                            />
                                                                        </FormControl>
                                                                    </Grid>
                                                                </>
                                                                    ...
                                                                    <Grid item md={4} xs={12} sm={12}>
                                                                        <FormControl fullWidth size="small">
                                                                            <OutlinedInput
                                                                                ...
                                                                                onChange={(e) => setBccEmailCreateEdit(e.target.value)}
                                                                            />
                                                                        </FormControl>
                                                                    </Grid>
                                                                </>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item md={6} xs={6} sm={6}>
                                        <LoadingButton sx={buttonStyles.buttonsubmit} variant="contained" type="submit" >Update</LoadingButton>
                                    </Grid>
                                    <Grid item md={6} xs={6} sm={6}>
                    ...
                    <>
                        <Box sx={userStyle.container}>
                            ...
                            {isUserRoleCompare?.includes("bdtemplatecontrolpanel") && (
                                <Button sx={buttonStyles.buttondelete} variant="contained" color="error" onClick={handleClickOpenalert} >Bulk Delete</Button>)}
            ...
            <Box>
                ...
                >
                    ...
                    <DialogActions>
                        <Button onClick={handleCloseMod} sx={buttonStyles.btncancel}>Cancel</Button>
            ...
            >
                <Box sx={{ padding: '30px 50px' }}>
                    <>
                        ...
                        <br /> <br />  <br />
                        <Grid container spacing={2}>
                            <Button sx={buttonStyles.btncancel} variant="contained" color="primary" onClick={handleCloseview}> Back </Button>
                        </Grid>
                    </>
                </Box>
            </Dialog>
            ...
            <Box>
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <LoadingButton sx={buttonStyles.buttonsubmit} loading={btnSubmit} autoFocus variant="contained" color='primary'
            ...
            <Box>
                ...
                >
                    ...
                    <DialogActions>
                        <Button onClick={handleCloseInfoImageEdit} sx={buttonStyles.btncancel}>Cancel</Button>
                        <LoadingButton sx={buttonStyles.buttonsubmit} loading={btnSubmitEdit} autoFocus variant="contained" color='primary'
