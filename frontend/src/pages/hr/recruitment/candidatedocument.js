...
function CandidateDocument() {
    ...
    if (isfilter === "filtered") {
      exportToCSV(
        rowDataTable?.map((t, index) => ({
          ...
          "File Name": t.candidatefilename,
          "Short Name": t.shortname,
          "All Resume": t.allresume,
        })),
        fileName
      );
  ...
  const columns = [
    ...
    { title: "File Name", field: "candidatefilename" },
    { title: "File Name", field: "shortname" },
    { title: "File Name", field: "allresume" },
  ];
  ...
  const downloadPdf = (isfilter) => {
      ...
      isfilter === "filtered"
        ? rowDataTable.map((t, index) => {
            return {
              ...
              designation: t.designation,
              candidatefilename: t.candidatefilename,
              shortname: t.shortname,
              allresume: t.allresume,
            };
          })
        : items?.map((t, index) => ({
            serialNumber: index + 1,
    ...
    doc.save("Candidate Document.pdf");
  };
  ...
  const delCandidateDocument = async (e) => {
    setPageName(!pageName);
    try {
      if (Candidatesid) {
        await axios.delete(`${SERVICE.CANDIDATEDOCUMENT_SINGLE}/${e}`, {
          headers: {
            Authorization: `Bearer ${auth.APIToken}`,
          },
        });
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading
        title="Manage Candidate Document"
        ...
        >
          ...
          <DialogActions>
            ...
            <Button
              ...
              variant="contained"
              color="error"
              onClick={(e) => delCandidateDocument(Candidatesid)}
            >
              {" "}
              OK{" "}
            </Button>
          ...
          >
            <TableHead>
              <TableRow>
                ...
                <TableCell>All Resume</TableCell>
              </TableRow>
            </TableHead>
              ...
              {rowDataTable &&
                rowDataTable.map((row, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell>{row.allresume}</TableCell>
                  </TableRow>
                ))}
            </TableBody>
          </Table>
        ...
        >
          ...
          <DialogActions>
            ...
            <Button
              ...
              variant="contained"
              color="error"
              onClick={(e) => delCandidatecheckbox(e)}
            >
              {" "}
              OK{" "}
            </Button>
