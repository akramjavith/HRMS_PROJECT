...
export const keywordsOptions = [
  ...
  { label: "AADHAAR NUMBER", value: "AADHAAR NUMBER" },
...
export const messagereceivedfromOptions = [
  { label: "Social Media", value: "Social Media" },
  { label: "Newspaper", value: "Newspaper" },
  { label: "EB Office", value: "EB Office" },
...
export const meetingModeOption = [
...
export const particularModeOptions = [
...
export const followUpActionOption = [
...
export const statusOptiontyping = [
  {
    label: "Eligible",
    value: "Eligible",
  },
...
export const candidatestatusOption = [
  { label: "Fresher", value: "Fresher" },
  { label: "Experience", value: "Experience" },
  { label: "Non-Experience", value: "Non-Experience" },
  { label: "Re-Join", value: "Re-Join" },
  { label: "Experience-Not In Domain", value: "Experience-Not In Domain" },
];

export const workmodeOption = [
  { label: "Remote", value: "Remote" },
  { label: "Facility", value: "Facility" },
];

export const question_preference = [
