...
function ProductionOriginalSummary() {
  ...
  //         axios.post(SERVICE.PRODUCTION_ORIGINAL_SUMMARY_REPORT, {
  //           headers: {
  //             Authorization: `Bearer ${auth.APIToken}`,
  //           },
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading title="Production Original Summary " modulename="Production" submodulename="SetUp" mainpagename="Production Original Summary " subpagename="" subsubpagename="" />
      <>
