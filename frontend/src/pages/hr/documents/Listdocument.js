...
try {
        ...
        } catch (err) { setListofdocumentcheck(true); handleApiError(err, setPopupContentMalert, setPopupSeverityMalert, handleClickOpenPopupMalert); }
    }
            ...
            renderCell: (params) => (
                <Grid sx={{ display: 'flex' }}>
                    {isUserRoleCompare?.includes("elistofdocument") && (
                        ...
                        }}><EditOutlinedIcon sx={buttonStyles.buttonedit} style={{ fontsize: 'large' }} /></Button>
                    )}
                    {isUserRoleCompare?.includes("dlistofdocument") && (
                        <Button sx={userStyle.buttondelete} onClick={(e) => { rowData(params.row.id, params.row.name) }}><DeleteOutlineOutlinedIcon sx={buttonStyles.buttondelete} style={{ fontsize: 'large' }} /></Button>
                    )}
                            ...
                            <form onSubmit={editSubmit}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item md={6} xs={6} sm={6}>
                                        <Button sx={buttonStyles.buttonsubmit} variant="contained" type="submit">Update</Button>
                                    </Grid>
                                    <Grid item md={6} xs={6} sm={6}>
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <Button autoFocus variant="contained" color='error'
                            onClick={(e) => delListofdoc(Listofdocsid)}
