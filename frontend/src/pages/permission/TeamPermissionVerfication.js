...
import { FaPrint, FaFilePdf, FaPlus, FaCheck, FaEdit } from "react-icons/fa";
...
function TeamPermissionVerification() {
      ...
      setShowAlert(
        <>
          <CheckCircleOutlinedIcon
            sx={{ fontSize: "100px", color: "#4CAF50" }}
          />
          <p style={{ fontSize: "20px", fontWeight: 900, textAlign: "center" }}>
            {"Added Successfully "}
          </p>
        </>
      );
  ...
  const handleSubmit = (e) => {
    ...
    const nameCheck = allpermissions.some(
      (item) =>
        item.company === applypermission.company &&
    ...
    if (
      ...
      Accessdrop === "HR" &&
      applypermission.company === "Please Select Company"
    ) {
      setShowAlert(
        <>
          <ErrorOutlineOutlinedIcon
      ...
      setShowAlert(
        <>
          ...
          />
          <p style={{ fontSize: "20px", fontWeight: 900 }}>
            {"Permission Was Already Added to this Employee to Date!"}
          </p>
        </>
      );
      handleClickOpenerr();
      ...
      (applytype !== "inbetween" &&
        (applytype == "beforeshift" || applytype == "endshift") &&
        hours1 > hours2) ||
      ...
      setShowAlert(
        <>
          ...
          >{`Select the time between  ${showMinTime} and ${showMaxTime}`}</p>
        </>
      );
      handleClickOpenerr();
    } else {
  ...
  const editSubmit = (e) => {
    ...
    if (
      ...
      (applytypeEdit !== "inbetween" &&
        (applytypeEdit == "beforeshift" || applytypeEdit == "endshift") &&
        hours1 > hours2) ||
      (hours1 === hours2 && minutes1 > minutes2) ||
      (hours1 === hours2 && minutes1 === minutes2 && seconds1 > seconds2) ||
      hours1 < hours3 ||
      ...
      setShowAlert(
        <>
          ...
          <p
            style={{ fontSize: "20px", fontWeight: 900 }}
          >{`Select the time between ${showMinTimeEdit} and ${showMaxTimeEdit}`}</p>
        </>
      );
      handleClickOpenerr();
    } else {
      ...
      renderCell: (params) => (
        <Grid sx={{ display: "flex" }}>
          {/* {(!(
            ...
            ["Approved", "Rejected"].includes(params.row.status)) ||
  ...
  // Excel
  const fileName = "TeamPermissionVerification";
  ...
  const downloadPdf = (isfilter) => {
    ...
    doc.save("Team Permission Verification.pdf");
  };
              ...
              >
                ...
                <Grid container spacing={2}>
                  <Grid item md={8} xs={12} sm={12}>
                    <Typography sx={userStyle.HeaderText}>
                      Edit Team Permission Verification
                    </Typography>
                  </Grid>
                  {(isUserRoleAccess.role.includes("HiringManager") ||
                    isUserRoleAccess.role.includes("HR") ||
      ...
      {isUserRoleCompare?.includes("lteampermissionverification") && (
        <>
          <Box sx={userStyle.container}>
            ...
            &ensp;
            {/* {isUserRoleCompare?.includes("bdteampermissionverification") && (
              <>
                <Button
                  variant="contained"
                  color="error"
      ...
      <Box>
        ...
        >
          <Box sx={{ width: "550px", padding: "20px 50px" }}>
            <>
              <Typography sx={userStyle.HeaderText}>
                Team Permission Verification Info
              </Typography>
              <br />
              <br />
              <Grid container spacing={2}>
          ...
          <>
            ...
            >
              ...
              <Grid container spacing={2}>
                <Grid item md={8} xs={12} sm={12}>
                  <Typography sx={userStyle.HeaderText}>
                    View Team Permission Verification
                  </Typography>
                </Grid>
                {(isUserRoleAccess.role.includes("HiringManager") ||
                  isUserRoleAccess.role.includes("HR") ||
