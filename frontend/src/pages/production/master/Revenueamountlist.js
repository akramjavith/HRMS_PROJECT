...
function RevenueAmountList() {
    ...
    const fetchEmployee = async () => {
        const queryParams = {
            ...
            processcode: processnames,
            allFilters:
                additionalFilters.length > 0 || (selectedColumn && filterValue)
                    ? [...additionalFilters, { column: selectedColumn, condition: selectedCondition, value: filterValue }]
                    : [],
            logicOperator,
    ...
    const fetchFilter = async () => {
        ...
        try {
            ...
            setPageSize(filteredData.length > 0 ? pageSize : 10);
            setPage(filteredData.length > 0 ? page : 1);
            setSearchQuery("");
    ...
    return (
        <Box>
            ...
            <PageHeading
                ...
                submodulename="SetUp"
                mainpagename="Revenue Amount List"
                subpagename=""
                subsubpagename=""
            />
            <br />
                    ...
                    <Box sx={userStyle.selectcontainer}>
                        ...
                        <Grid container spacing={2}>
                            <Grid item md={3} xs={12} sm={6}>
                                <Button variant='contained' color='primary' sx={buttonStyles.buttonsubmit} onClick={handleSubmitFilter}>Filter</Button>
                ...
                {isUserRoleCompare?.includes("lrevenueamountlist") && (
                  ...
                  />
                            ...
                            {isUserRoleCompare?.includes("bdrevenueamountlist") && (
                                <Button sx={buttonStyles.buttonbulkdelete} size="small"
