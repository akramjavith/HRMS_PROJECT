    ...
    return (
        <Box>
            ...
            <PageHeading
                ...
                mainpagename="Team Asset Acceptance List"
                subpagename=""
                subsubpagename=""
            />
            {/* ****** Table Start ****** */}
                    ...
                    <Box sx={userStyle.container}>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item lg={3} md={2} xs={12} sm={6}>
                                <LoadingButton loading={isBtn} variant="contained"
