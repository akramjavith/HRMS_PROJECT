...
function Assignpfesi() {
  ...
  const handleCaptureImage = () => {
    if (gridRefTableImg.current) {
      domtoimage.toBlob(gridRefTableImg.current)
        .then((blob) => {
          saveAs(blob, "Assign PF-ESI Detail.png");
        })
        .catch((error) => {
  ...
  const handleprint = useReactToPrint({
    ...
    documentTitle: "Assign PF-ESI Detail",
    pageStyle: "print",
  });
  ...
  const getapi = async () => {
    let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
      ...
      pagename: String("Assign PF-ESI Detail"),
  ...
  return (
    <Box>
      ...
      <PageHeading
        title="Manage Assign PF-ESI Detail"
        modulename="Human Resources"
        submodulename="HR"
        mainpagename="Employee"
        subpagename="Employee Log Details"
        subsubpagename="Assign PF-ESI"
      />
      <br />
