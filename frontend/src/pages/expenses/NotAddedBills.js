...
function NotAddedBills() {
            ...
            <Button
              ...
              onClick={() => {
                handleClickOpenMeetingPopup(
                  params?.row?.company,
                  params?.row?.branch,
                  params?.row?.expensecategory,
                  params?.row?.expensesubcategory,
                  params?.row?.purpose,
                  params?.row?.vendor,
  ...
  return (
    <Box>
      ...
      <PageHeading
        title="Manage Scheduled Payment Bills"
        modulename="Expenses"
      ...
      <AddedBills vendorAuto={vendorAuto} />
      <br />
      <IgnoredBills vendorAuto={vendorAuto} />
