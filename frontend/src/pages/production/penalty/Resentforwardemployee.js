...
function ResentForwardEmployee() {
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "Resent Forward Employee Client Error Waiver Request.png");
                })
                .catch((error) => {
    ...
    const handleCaptureImagetwo = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "Recheck Employee Client Error Waiver Request.png");
                })
                .catch((error) => {
                    console.error("dom-to-image error: ", error);
                });
    ...
    const columnDataTabletwo = [
        ...
        },
        {
            ...
            flex: 0,
            width: 100,
            hide: !columnVisibilitytwo.action,
            headerClassName: "bold-header",
        },
        {
            field: "mode",
    ...
    return (
        <Box>
                    ...
                    <Box sx={userStyle.container}>
                        ...
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>
                                 Resent Forward Employee Client Error Waiver Request List
                            </Typography>
                        </Grid>
            ...
            {isUserRoleCompare?.includes("lclienterrorforward") && (
                ...
                <>
                    <Box sx={userStyle.container}>
                        ...
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>
                                  Recheck Employee Client Error Waiver Request List
                            </Typography>
                        </Grid>
                        <Grid container spacing={2} style={userStyle.dataTablestyle}>
                            <Grid item md={2} xs={12} sm={12}>
            ...
            <ExportData
                ...
                filename={"Resent Forward Employee Client Error Waiver Request"}
            ...
            <ExportData
                ...
                filename={"Recheck Employee Client Error Waiver Request"}
