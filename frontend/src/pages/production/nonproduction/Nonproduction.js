...
function Nonproduction() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const isNameMatch = taskcategorys.some((item) => item.category.toLowerCase() == nonProductionState.category.toLowerCase() && item.subcategory.toLowerCase() == nonProductionState.subcategory.toLowerCase() && item.name == isUserRoleAccess.companyname);
  ...
  const editSubmit = async (e) => {
    ...
    const isNameMatch = resdata.some((item) => item.category.toLowerCase() === nonProductionEdit.category.toLowerCase() && item.subcategory.toLowerCase() == nonProductionEdit.subcategory.toLowerCase() && item.name == nonProductionEdit.name);
  ...
  const getCategoryAndSubcategory = async (e) => {
    ...
    try {
      ...
      const filterAlloted = NonProduction?.data?.nonproductionunitallot?.filter((item) => item?.employeename?.toLowerCase() === isUserRoleAccess?.companyname?.toLowerCase() && item?.category?.toLowerCase() === e?.value?.toLowerCase());
      const result = filterAlloted?.map((t) => ({
        ...t,
        label: t.subcategory,
        value: t.subcategory,
      }));
      const removeDup = result.filter((item, index, self) => index === self.findIndex((t) => t.value === item.value));
  ...
  const getCategoryAndSubcategoryEdit = async (e) => {
    ...
    try {
      ...
      const filterAlloted = NonProduction?.data?.nonproductionunitallot?.filter((item) => item?.employeename?.toLowerCase() === isUserRoleAccess?.companyname?.toLowerCase() && item?.category?.toLowerCase() === e?.toLowerCase());
      const result = filterAlloted?.map((t) => ({
        ...t,
        label: t.subcategory,
        value: t.subcategory,
  ...
  const fetchTaskcategory = async () => {
    ...
    try {
      ...
      if (!isUserRoleAccess.role.includes('Manager')) {
        ...
        setTaskcategorys(
          res_vendor?.data?.nonproduction?.map((t, index) => ({
            ...t,
            serialNumber: index + 1,
            name: t.name,
            category: t.category,
  ...
  const fetchTaskcategoryForPagination = async () => {
    ...
    try {
      let res_vendor = await axios.post(SERVICE.NONPRODUCTION_PAGINATION, queryParams, {
        headers: {
          Authorization: `Bearer ${auth.APIToken}`,
        },
      });
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading title="Non Production" modulename="Production" submodulename="Non Production" mainpagename="Non-production Setup" subpagename="Non Productions" subsubpagename="" />
              ...
              <Grid container spacing={2}>
                ...
                <Grid item md={4} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    ...
                    <OutlinedInput id="component-outlined" type="text" placeholder="Please Enter Mode" value={modeState} readOnly={true} />
                  </FormControl>
                </Grid>
                <Grid item md={4} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    ...
                    <OutlinedInput id="component-outlined" type="text" placeholder="Please Enter Count" value={countvalue} />
                  </FormControl>
                </Grid>
                <Grid item md={4} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                ...
                <Grid item md={4} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    ...
                    <OutlinedInput id="component-outlined" type="time" value={nonProductionState.totime} onChange={handleToTimeChange} />
                  </FormControl>
                </Grid>
                <Grid item md={4} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    ...
                    <OutlinedInput id="component-outlined" type="teaxt" placeholder="" readOnly={true} value={nonProductionState.totalhours} />
                  </FormControl>
                </Grid>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item md={4} xs={12} sm={12}>
                    <FormControl fullWidth size="small">
                      ...
                      <OutlinedInput id="component-outlined" type="text" placeholder="Please Enter Mode" value={modeEdit} />
                    </FormControl>
                  </Grid>
                  <Grid item md={4} xs={12} sm={12}>
                    <FormControl fullWidth size="small">
                      ...
                      <OutlinedInput id="component-outlined" type="text" placeholder="Please Enter Count" value={countEdit} />
                    </FormControl>
                  </Grid>
                  <Grid item md={4} xs={12} sm={12}>
                    <FormControl fullWidth size="small">
                  ...
                  <Grid item md={4} xs={12} sm={12}>
                    <FormControl fullWidth size="small">
                      ...
                      <OutlinedInput id="component-outlined" type="time" value={nonProductionEdit.totime} onChange={handleToTimeChangeEdit} />
                    </FormControl>
                  </Grid>
                  <Grid item md={4} xs={12} sm={12}>
                    <FormControl fullWidth size="small">
                      ...
                      <OutlinedInput id="component-outlined" type="teaxt" placeholder="" readOnly={true} value={nonProductionEdit.totalhours} />
                    </FormControl>
                  </Grid>
                </Grid>
                <br />
      ...
      />
      <InfoPopup openInfo={openInfo} handleCloseinfo={handleCloseinfo} heading="Non Production Info" addedby={addedby} updateby={updateby} />
