...
function SelfCheckPointTicketMaster() {
  ...
  const { isUserRoleCompare, allProjects, isUserRoleAccess, pageName,
    setPageName,
  ...
  const fetchCheckpointticketmaster = async () => {
    ...
    try {
      ...
      const answer = res_vendor?.data?.selfcheckpointticketmasters?.length > 0 ? res_vendor?.data?.selfcheckpointticketmasters?.map(
        (item, index) => ({
  ...
  return (
    <Box>
      ...
      <PageHeading
        ...
        mainpagename="Self Checkpoint Ticket Master"
        subpagename=""
        subsubpagename=""
      />
      ...
      <InfoPopup
        ...
        heading="Self Checkpoint Master Info"
        addedby={addedby}
        updateby={updateby}
      />
    </Box>
