...
function CandidateView() {
  ...
  const fetchCandidateData = async () => {
    try {
      ...
      // console.log(res_queue?.data?.scandidates, "res_queue?.data?.scandidates")
      setAddcandidate({
            ...
            <Grid item md={3} sm={6} xs={12}>
              <FormControl fullWidth size="small">
                ...
                <OutlinedInput
                  id="component-outlined"
                  type="text"
                  value={addcandidate.joiningbydaysopts === "Please Select Joining By Days" ? "" : addcandidate.joiningbydaysopts}
                  sx={userStyle.input}
