...
import "../../hr/employees/MultistepForm.css";
...
function InternDraftView() {
  ...
  const [backPath, setBackPath] = useState("/interndraftlist");
  const [headTitle, setHeadTitle] = useState("");

  useEffect(() => {
    switch (from) {
      case "employee":
        setBackPath("/draftlist");
        setHeadTitle("EMPLOYEE DRAFT VIEW");
        break;
      case "intern":
        setBackPath("/interndraftlist");
        setHeadTitle("INTERN DRAFT VIEW");
        break;
  ...
  const fetchHandlerEdit = async () => {
    try {
      ...
      setBankTodo(response?.data?.sdraft?.bankdetails);
      setCreateRocketChat({
        create: response?.data?.sdraft?.rocketchatid ? true : false,
        email: response?.data?.sdraft?.rocketchatemail ?? "",
        roles: response?.data?.sdraft?.rocketchatroles ? response?.data?.sdraft?.rocketchatroles?.map((data) => ({
          label: data,
          value: data,
        })) : []
      })
      ...
      setPrimaryWorkStation(
        response?.data?.sdraft?.workstation[0] ===
          "Please Select Primary Work Station"
          ? ""
          : response?.data?.sdraft?.workstation[0]
      );
                  ...
                  <>
                    <Grid item md={4} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput value={employee.modeOfInt} readOnly={true} />

                      </FormControl>
                    </Grid>
                    {employee.modeOfInt === "Offline" && (
                      <Grid item md={4} sm={12} xs={12}>
                        <FormControl fullWidth size="small">
                          <Typography>Duration</Typography>
                          <OutlinedInput value={employee.intDuration} readOnly={true} />
                      ...
                      <Grid container spacing={2}>
                        <Grid item md={6} sm={12} xs={12}>
                          <FormControl fullWidth size="small">
                            ...
                            <OutlinedInput value={employee.intStartDate} readOnly={true} />
                        ...
                        <Grid item md={6} sm={12} xs={12}>
                          <FormControl fullWidth size="small">
                            ...
                            <OutlinedInput value={employee.intEndDate} readOnly={true} />
                          </FormControl>
                        </Grid>
                      </Grid>
                    </Grid>
                ...
                <>
                  <Grid container spacing={2}>
                    ...
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        <Typography>State</Typography>
                        <OutlinedInput value={selectedStatec?.name} readOnly={true} />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
...
export default InternDraftView;