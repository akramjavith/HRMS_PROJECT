...
import { Box, Typography, OutlinedInput, Dialog, Select, TableRow, TableCell, MenuItem, TableBody, DialogContent, DialogActions, FormControl, Grid, Paper, Table, TableHead, TableContainer, Button, List, ListItem, ListItemText, Popover, Checkbox, TextField, IconButton } from "@mui/material";
...
const Certification = () => {
  ...
  const fetchUnits = async () => {
    ...
    } catch (err) {setIscertificate(true);handleApiError(err, setShowAlert, handleClickOpenerr);}
  }
  ...
  const handleExportXL = (isfilter) => {
    ...
    exportToExcel(formatData(dataToExport), 'Certification');
    setIsFilterOpen(false);
  };
