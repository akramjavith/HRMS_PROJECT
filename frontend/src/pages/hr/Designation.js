...
function Designation() {
  ...
  const { isUserRoleAccess, isUserRoleCompare, pageName, setPageName } = useContext(
  ...
  const fetchDesignation = async () => {
    ...
    } catch (err) { setIsDesignation(true); handleApiError(err, setShowAlert, handleClickOpenerr); }
  };
  ...
  const rowData = async (id, name) => {
    ...
    try {
      ...
      setCheckUser(resdesg?.data?.count);
    ...
    if (
      ...
      setShowAlert(
        <>
          ...
          />
          <p style={{ fontSize: "20px", fontWeight: 900 }}>
            {"Please Enter Notice period No.Of Months"}
          </p>
        </>
      );
      handleClickOpenerr();
      ...
      setShowAlert(
        <>
          ...
          />
          <p style={{ fontSize: "20px", fontWeight: 900 }}>
            {"Please Enter Notice period No.Of Days"}
          </p>
        </>
      );
      handleClickOpenerr();
