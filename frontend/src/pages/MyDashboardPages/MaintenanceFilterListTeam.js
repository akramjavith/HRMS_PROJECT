...
function MaintenanceList() {
  ...
  let exportColumnNames = ['Vendor', 'Employee Name', 'Date', 'Asset Material', 'Status'];
  let exportRowValues = ['employeenameto', 'date', 'assetmaterial', 'status'];
  ...
  const { isUserRoleCompare, listPageAccessMode,isUserRoleAccess, pageName, setPageName, buttonStyles } = useContext(UserRoleAccessContext);
  ...
  const fetchProductionIndividual = async () => {
    ...
    try {
      ...
      let res_project = await axios.post(SERVICE.MAINTENANCE_TASK_FOR_USER_TEAM_LIST, {
        headers: {
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading title="Task Maintenance List" modulename="Production" submodulename="Manual Entry" mainpagename="Approve List" subpagename="" subsubpagename="" />
        ...
        <>
          <Box sx={userStyle.container}>
            ...
            <Grid container spacing={2} style={userStyle.dataTablestyle}>
              ...
              <Grid item md={2} xs={12} sm={12}>
                <Box>
                  <AggregatedSearchBar columnDataTable={columnDataTable} setItems={setItems} addSerialNumber={addSerialNumber} setPage={setPage} maindatas={projmaster} setSearchedString={setSearchedString} searchQuery={searchQuery} paginated={false} totalDatas={projmaster} />
                </Box>
              </Grid>
            </Grid>
            <br />
