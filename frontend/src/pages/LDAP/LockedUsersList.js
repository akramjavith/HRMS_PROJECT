...
function LockedUsersList() {
  ...
  const getapi = async () => {
    let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
      ...
      pagename: String("Locked Users List"),
  ...
  const handleCaptureImage = () => {
    if (gridRefTableImg.current) {
      domtoimage
        ...
        .then((blob) => {
          saveAs(blob, "Locked/Unlocked Users List.png");
        })
        .catch((error) => {
  ...
  const handleprint = useReactToPrint({
    ...
    documentTitle: "Locked Users List",
    pageStyle: "print",
  });
...

    {
      ...
      cellRenderer: (params) => (
        <Grid sx={{ display: "flex" }}>
          {isUserRoleCompare?.includes("elockeduserslist") &&
          ...
          {isUserRoleCompare?.includes("vlockeduserslist") && (
            <Button
              sx={userStyle.buttonedit}
              onClick={() => {
  ...
  return (
    <Box>
      <NotificationContainer />
      <Headtitle title={"Locked Users List"} />
      {/* ****** Header Content ****** */}
      <PageHeading
        title="Locked Users List"
        modulename="LDAP"
        submodulename="Locked Users List"
        mainpagename=""
        subpagename=""
        subsubpagename=""
      />
      {isUserRoleCompare?.includes("alockeduserslist") && (
        <>
      ...
      {tableLoader ? (
        ...
        <>
          {isUserRoleCompare?.includes("llockeduserslist") && (
            <>
              <Box sx={userStyle.container}>
                {/* ******************************************************EXPORT Buttons****************************************************** */}
                <Grid container spacing={2}>
                ...
                <Grid container spacing={2} style={userStyle.dataTablestyle}>
                  ...
                  >
                    <Box>
                      {isUserRoleCompare?.includes("excellockeduserslist") && (
                        <>
                          <Button
                            onClick={(e) => {
                      ...
                      {isUserRoleCompare?.includes("csvlockeduserslist") && (
                        <>
                          <Button
                            onClick={(e) => {
                              setIsFilterOpen(true);
                      ...
                      {isUserRoleCompare?.includes("printlockeduserslist") && (
                        <>
                          <Button
                            sx={userStyle.buttongrp}
                            onClick={handleprint}
                      ...
                      {isUserRoleCompare?.includes("pdflockeduserslist") && (
                        <>
                          <Button
                            sx={userStyle.buttongrp}
                            onClick={() => {
                      ...
                      {isUserRoleCompare?.includes("imagelockeduserslist") && (
                        <Button
                          sx={userStyle.buttongrp}
      ...
      <ExportData
        ...
        itemsTwo={employees ?? []}
        filename={"Locked/Unlocked Users List"}
