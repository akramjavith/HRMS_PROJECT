...
import {
    ...
    Radio,
    RadioGroup,
    Select, Table, TableBody, TableContainer, TableHead, TextareaAutosize,
    TextField,
    Tooltip,
    Typography
} from "@mui/material";
...
function ApprovedLoan() {
    ...
    //     setPageName(!pageName)
    //     try {
    //         let res_grp = await axios.post(SERVICE.LOANBYASSIGNBRANCH_FOROPTIMIZE_APPROVED, {
    ...
    const fetchAllGroup = async () => {
        ...
        try {
            let res_grp = await axios.post(SERVICE.LOANBYASSIGNBRANCH_FOROPTIMIZE_APPROVED, queryParams,
                {
                    headers: {
                        Authorization: `Bearer ${auth.APIToken}`,
                    },
    ...
    const fetchAllApprovedLoanArray = async () => {
        ...
        try {
            let res_grp = await axios.post(SERVICE.LOANBYASSIGNBRANCH_PAGINATION_EXPORTS_APPROVED, queryParams, {
                headers: {
                    Authorization: `Bearer ${auth.APIToken}`,
                },
            });
            setApprovedLoanArray(res_grp?.data?.loan)
