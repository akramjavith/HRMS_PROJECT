...
exports.salarySlabFilter = catchAsyncErrors(async (req, res, next) => {
  ...
  try {
    ...
    salaryslab = await SalarySlab.find({}, {
      ...
      pfpercentage: 1,epspercentage:1, pfemployeepercentage: 1, esiemployeepercentage: 1
...
exports.getsalarySlabProcessFilterSortByAssignBranch = catchAsyncErrors(async (req, res, next) => {
  ...
  try {
    ...
    const overallitems = await SalarySlab.find(queryoverall, { company: 1, branch: 1, processqueue: 1,
       salarycode: 1, basic: 1, hra: 1, conveyance: 1, medicalallownace: 1, productionallowance: 1, 
       otherallowance: 1, shiftallowance: 1, esieducation: 1, pfeducation: 1,
