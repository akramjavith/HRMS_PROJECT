...
function AssignUserName() {
  ...
  let exportColumnNames = ['Company', 'Branch', 'Unit', 'Department', 'Team', 'Work Mode', 'Emp Code', 'Name', 'Username'];
  let exportRowValues = ['company', 'branch', 'unit', 'department', 'team', 'workmode', 'empcode', 'companyname', 'username'];
