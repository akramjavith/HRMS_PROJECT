...
exports.getAllPenaltyerroruploadpointsClientUserId = catchAsyncErrors(async (req, res, next) => {
  let penaltyerroruploadpoints,clientuserid;
  try {
let query = {
  projectvendor:req.body.projectvendor,
...
exports.getAllPenaltyErrorUploadPointsByDate = catchAsyncErrors(async (req, res, next) => {
  let penaltyerroruploadpoints;
  try {
