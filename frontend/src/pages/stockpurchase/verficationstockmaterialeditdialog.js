...
function Stockmaterialeditdialog({ vendorAuto, openpop,
    vendorGroup, requestquantity, availqty,
    vendorNew,
    stockmanagemasteredit1, refImageedit, refImagewarrantyedit, handleChangeGroupName,
    stockArray, subcategoryOpt, materialOptNew, floorsEdit, vendorgetid, selectedPurchaseDateEdit, handleCloseviewalertvendorstock }) {
