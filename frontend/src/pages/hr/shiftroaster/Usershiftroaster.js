...
function UserShiftRoasterList() {
    ...
    const [filterUser, setFilterUser] = useState({
        mode: "Please Select Mode", fromdate: today, todate: today,
    });
    ...
    //     // setFilteredEntries(itemsWithSerialNumber.length);
    // };
    ...
    const filteredDatas = userShifts?.filter((item) => {
    ...
    const columnDataTable = [
        ...
        {
            field: "clockinstatus", headerName: "ClockInStatus", flex: 0, width: 130, hide: !columnVisibility.clockinstatus, headerClassName: "bold-header",
            renderCell: (params) => {
                return (
                    <Grid>
                        <Button size="small"
                            sx={{
                                ...
                                display: 'flex',
                                padding: (params.row.clockinstatus === 'BeforeWeekOffAbsent' || params.row.clockinstatus === 'BeforeWeekOffLeave') ? '3px 5px' : '3px 8px',
                                cursor: 'default',
                                color: (params.row.clockinstatus === 'Present' || params.row.clockinstatus === 'Early - ClockIn') ? 'black' : params.row.clockinstatus === 'Holiday' ? 'black' : params.row.clockinstatus === 'Leave' ? 'white' : params.row.clockinstatus === 'Absent' ? '#462929' : params.row.clockinstatus === 'Week Off' ? 'white' : params.row.clockinstatus === 'Grace - ClockIn' ? '#052106' : params.row.clockinstatus === 'On - Present' ? 'black' : params.row.clockinstatus === 'HBLOP' ? 'white' : params.row.clockinstatus === 'FLOP' ? 'white' : (params.row.clockinstatus === 'AfterWeekOffAbsent' || params.row.clockinstatus === 'AfterWeekOffLeave') ? 'black' : (params.row.clockinstatus === 'BeforeWeekOffAbsent' || params.row.clockinstatus === 'BeforeWeekOffLeave') ? 'black' : params.row.clockinstatus === 'Late - ClockIn' ? '#15111d' : '#15111d',
                                backgroundColor: (params.row.clockinstatus === 'Present' || params.row.clockinstatus === 'Early - ClockIn') ? 'rgb(156 239 156)' : params.row.clockinstatus === 'Holiday' ? '#B6FFFA' : params.row.clockinstatus === 'Leave' ? '#1640D6' : params.row.clockinstatus === "Absent" ? '#ff00007d' : params.row.clockinstatus === 'Week Off' ? '#6b777991' : params.row.clockinstatus === 'Grace - ClockIn' ? 'rgb(243 203 117)' : params.row.clockinstatus === 'On - Present' ? '#E1AFD1' : params.row.clockinstatus === 'HBLOP' ? '#DA0C81' : params.row.clockinstatus === 'FLOP' ? '#FE0000' : (params.row.clockinstatus === 'AfterWeekOffAbsent' || params.row.clockinstatus === 'AfterWeekOffLeave') ? '#F2D1D1' : (params.row.clockinstatus === 'BeforeWeekOffAbsent' || params.row.clockinstatus === 'BeforeWeekOffLeave') ? '#EEE3CB' : params.row.clockinstatus === 'Late - ClockIn' ? '#610c9f57' : 'rgb(243 203 117)',
                                '&:hover': {
                                    color: (params.row.clockinstatus === 'Present' || params.row.clockinstatus === 'Early - ClockIn') ? 'black' : params.row.clockinstatus === 'Holiday' ? 'black' : params.row.clockinstatus === 'Leave' ? 'white' : params.row.clockinstatus === 'Absent' ? '#462929' : params.row.clockinstatus === 'Week Off' ? 'white' : params.row.clockinstatus === 'Grace - ClockIn' ? '#052106' : params.row.clockinstatus === 'On - Present' ? 'black' : params.row.clockinstatus === 'HBLOP' ? 'white' : params.row.clockinstatus === 'FLOP' ? 'white' : (params.row.clockinstatus === 'AfterWeekOffAbsent' || params.row.clockinstatus === 'AfterWeekOffLeave') ? 'black' : (params.row.clockinstatus === 'BeforeWeekOffAbsent' || params.row.clockinstatus === 'BeforeWeekOffLeave') ? 'black' : params.row.clockinstatus === 'Late - ClockIn' ? '#15111d' : '#15111d',
                                    backgroundColor: (params.row.clockinstatus === 'Present' || params.row.clockinstatus === 'Early - ClockIn') ? 'rgb(156 239 156)' : params.row.clockinstatus === 'Holiday' ? '#B6FFFA' : params.row.clockinstatus === 'Leave' ? '#1640D6' : params.row.clockinstatus === "Absent" ? '#ff00007d' : params.row.clockinstatus === 'Week Off' ? '#6b777991' : params.row.clockinstatus === 'Grace - ClockIn' ? 'rgb(243 203 117)' : params.row.clockinstatus === 'On - Present' ? '#E1AFD1' : params.row.clockinstatus === 'HBLOP' ? '#DA0C81' : params.row.clockinstatus === 'FLOP' ? '#FE0000' : (params.row.clockinstatus === 'AfterWeekOffAbsent' || params.row.clockinstatus === 'AfterWeekOffLeave') ? '#F2D1D1' : (params.row.clockinstatus === 'BeforeWeekOffAbsent' || params.row.clockinstatus === 'BeforeWeekOffLeave') ? '#EEE3CB' : params.row.clockinstatus === 'Late - ClockIn' ? '#610c9f57' : 'rgb(243 203 117)',
                                }
        ...
        {
            field: "clockoutstatus", headerName: "ClockOutStatus", flex: 0, width: 130, hide: !columnVisibility.clockoutstatus, headerClassName: "bold-header",
            renderCell: (params) => {
                return (
                    <Grid>
                        <Button size="small"
                            sx={{
                                ...
                                letterSpacing: '0.01071em',
                                display: 'flex',
                                padding: (params.row.clockoutstatus === 'BeforeWeekOffAbsent' || params.row.clockoutstatus === 'BeforeWeekOffLeave') ? '3px 5px' : '3px 8px',
                                cursor: 'default',
                                color: params.row.clockoutstatus === 'Holiday' ? 'black' : params.row.clockoutstatus === 'Leave' ? 'white' : params.row.clockoutstatus === 'Absent' ? '#462929' : params.row.clockoutstatus === 'Week Off' ? 'white' : params.row.clockoutstatus === 'On - ClockOut' ? 'black' : params.row.clockoutstatus === 'Over - ClockOut' ? '#052106' : params.row.clockoutstatus === 'Mis - ClockOut' ? '#15111d' : params.row.clockoutstatus === 'Early - ClockOut' ? '#052106' : params.row.clockoutstatus === 'HALOP' ? 'white' : params.row.clockoutstatus === 'FLOP' ? 'white' : (params.row.clockoutstatus === 'AfterWeekOffAbsent' || params.row.clockoutstatus === 'AfterWeekOffLeave') ? 'black' : (params.row.clockoutstatus === 'BeforeWeekOffAbsent' || params.row.clockoutstatus === 'BeforeWeekOffLeave') ? 'black' : params.row.clockoutstatus === 'Pending' ? '#052106' : '#052106',
                                backgroundColor: params.row.clockoutstatus === 'Holiday' ? '#B6FFFA' : params.row.clockoutstatus === 'Leave' ? '#1640D6' : params.row.clockoutstatus === "Absent" ? '#ff00007d' : params.row.clockoutstatus === 'Week Off' ? '#6b777991' : params.row.clockoutstatus === 'On - ClockOut' ? '#E1AFD1' : params.row.clockoutstatus === 'Over - ClockOut' ? 'rgb(156 239 156)' : params.row.clockoutstatus === 'Mis - ClockOut' ? '#610c9f57' : params.row.clockoutstatus === 'Early - ClockOut' ? 'rgb(243 203 117)' : params.row.clockoutstatus === 'HALOP' ? '#DA0C81' : params.row.clockoutstatus === 'FLOP' ? '#FE0000' : (params.row.clockoutstatus === 'AfterWeekOffAbsent' || params.row.clockoutstatus === 'AfterWeekOffLeave') ? '#F2D1D1' : (params.row.clockoutstatus === 'BeforeWeekOffAbsent' || params.row.clockoutstatus === 'BeforeWeekOffLeave') ? '#EEE3CB' : params.row.clockoutstatus === 'Pending' ? 'rgb(243 203 117)' : 'rgb(243 203 117)',
                                '&:hover': {
                                    color: params.row.clockoutstatus === 'Holiday' ? 'black' : params.row.clockoutstatus === 'Leave' ? 'white' : params.row.clockoutstatus === 'Absent' ? '#462929' : params.row.clockoutstatus === 'Week Off' ? 'white' : params.row.clockoutstatus === 'On - ClockOut' ? 'black' : params.row.clockoutstatus === 'Over - ClockOut' ? '#052106' : params.row.clockoutstatus === 'Mis - ClockOut' ? '#15111d' : params.row.clockoutstatus === 'Early - ClockOut' ? '#052106' : params.row.clockoutstatus === 'HALOP' ? 'white' : params.row.clockoutstatus === 'FLOP' ? 'white' : (params.row.clockoutstatus === 'AfterWeekOffAbsent' || params.row.clockoutstatus === 'AfterWeekOffLeave') ? 'black' : (params.row.clockoutstatus === 'BeforeWeekOffAbsent' || params.row.clockoutstatus === 'BeforeWeekOffLeave') ? 'black' : params.row.clockoutstatus === 'Pending' ? '#052106' : '#052106',
                                    backgroundColor: params.row.clockoutstatus === 'Holiday' ? '#B6FFFA' : params.row.clockoutstatus === 'Leave' ? '#1640D6' : params.row.clockoutstatus === "Absent" ? '#ff00007d' : params.row.clockoutstatus === 'Week Off' ? '#6b777991' : params.row.clockoutstatus === 'On - ClockOut' ? '#E1AFD1' : params.row.clockoutstatus === 'Over - ClockOut' ? 'rgb(156 239 156)' : params.row.clockoutstatus === 'Mis - ClockOut' ? '#610c9f57' : params.row.clockoutstatus === 'Early - ClockOut' ? 'rgb(243 203 117)' : params.row.clockoutstatus === 'HALOP' ? '#DA0C81' : params.row.clockoutstatus === 'FLOP' ? '#FE0000' : (params.row.clockoutstatus === 'AfterWeekOffAbsent' || params.row.clockoutstatus === 'AfterWeekOffLeave') ? '#F2D1D1' : (params.row.clockoutstatus === 'BeforeWeekOffAbsent' || params.row.clockoutstatus === 'BeforeWeekOffLeave') ? '#EEE3CB' : params.row.clockoutstatus === 'Pending' ? 'rgb(243 203 117)' : 'rgb(243 203 117)',
                                }
        ...
        {
            field: "attendanceauto", headerName: "Attendance", flex: 0, width: 130, hide: !columnVisibility.attendanceauto, headerClassName: "bold-header",
            renderCell: (params) => {
                return (
                    <Grid>
                        <Button size="small"
        ...
        {
            field: "daystatus", headerName: "Day Status", flex: 0, width: 130, hide: !columnVisibility.daystatus, headerClassName: "bold-header",
            renderCell: (params) => {
                return (
                    <Grid>
                        <Button size="small"
        ...
        { field: "appliedthrough", headerName: "Applied Through", flex: 0, width: 120, hide: !columnVisibility.appliedthrough, headerClassName: "bold-header", },
        { field: "lopcalculation", headerName: "LOP Calculation", flex: 0, width: 120, hide: !columnVisibility.lopcalculation, headerClassName: "bold-header", },
        { field: "modetarget", headerName: "Target", flex: 0, width: 120, hide: !columnVisibility.modetarget, headerClassName: "bold-header", },
        { field: "paidpresent", headerName: "Paid Present", flex: 0, width: 120, hide: !columnVisibility.paidpresent, headerClassName: "bold-header", },
        { field: "lopday", headerName: "LOP Day", flex: 0, width: 120, hide: !columnVisibility.lopday, headerClassName: "bold-header", },
        { field: "paidpresentday", headerName: "Paid Present Day", flex: 0, width: 120, hide: !columnVisibility.paidpresentday, headerClassName: "bold-header", },
    ];
    ...
    // Excel
    const fileName = "User Shift Roaster";
    ...
    const downloadPdf = (isfilter) => {
        ...
        const headers = ["SNo", "Emp Code", "Employee Name", "Company", "Branch", "Unit", "Team", "Department",
            "Date", "Shift Mode", "Shift", "ClockIn", "ClockInStatus", "ClockOut", "ClockOutStatus", "Attendance",
            "Day Status", "Applied Through", "LOP Calculation", "Target", "Paid Present", "LOP Day", "Paid Present Day",
        ];
        ...
        doc.save("User Shift Roaster.pdf");
    };
    ...
    return (
        <Box>
            ...
            {/* ****** Header Content ****** */}
            <Typography sx={userStyle.HeaderText}>User Shift Roaster</Typography>
