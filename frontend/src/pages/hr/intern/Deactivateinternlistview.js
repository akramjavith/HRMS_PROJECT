...
function DeactivateInternlistView() {
  ...
  const getapi = async () => {
    let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
      ...
      pagename: String("Deactivate Intern List View"),
  ...
  const handleAutoSelect = async () => {
    ...
    try {
      ...
      let filteredDatas = res?.data?.allinterns?.filter((item) => item.workmode === 'Internship')
  ...
  const fetchHandler = async () => {
    ...
    try {
      ...
      let res = await axios.post(
        ...
        subsubpage: "Deactivate Intern List View",
  ...
  const deleteChecklist = async () => {
    ...
    const searchItem = datasAvailedDB.find(
      (item) =>
        ...
        item.subsubpage === "Deactivate Intern List View"
    );
    setPageName(!pageName)
    try {
  ...
  const handleExportXL = (isfilter) => {
    ...
    exportToExcel(dataToExport, "Deactivate Intern List View");
    setIsFilterOpen(false);
  };
      ...
      cellRenderer: (params) => (
        <>
          <Grid sx={{ display: "flex", gap: '10px' }}>
            ...
            <Link
              to={`/view/${params?.data?.id}/deactivateinternlist`}
              style={{
                textDecoration: "none",
                color: "#fff",
              }}
  ...
  return (
    <Box>
      <NotificationContainer />
      {/* ****** Header Content ****** */}
      <Headtitle title={"Deactivate Intern List View"} />
      <PageHeading
        ...
        subsubpagename="Deactivate Intern List View"
      />
        ...
        <Box sx={{ padding: "20px 50px" }}>
          <>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <Typography sx={userStyle.HeaderText}> Deactivate Intern List View</Typography>
