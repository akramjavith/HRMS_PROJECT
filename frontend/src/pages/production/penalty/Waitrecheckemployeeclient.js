...
function WaitRecheckEmployeeClient() {
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "Wait Recheck Employee Client Error Waiver Request.png");
                })
                .catch((error) => {
    ...
    return (
        <Box>
                    ...
                    <Box sx={userStyle.container}>
                        ...
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>
                                Wait Recheck Employee Client Error Waiver Request List
                            </Typography>
                        </Grid>
            ...
            <ExportData
                ...
                filename={"Wait Recheck Employee Client Error Waiver Request"}
