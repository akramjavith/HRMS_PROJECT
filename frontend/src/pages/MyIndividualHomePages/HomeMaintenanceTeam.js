...
const HomeMaintenance = () => {
  ...
  const fetchAchievedAccuracyIndividual = async (e) => {
    ...
    try {
      ...
      if (isUserRoleCompare?.includes('lmaintenances')) {
        let request = await axios.post(SERVICE.MAINTENANCE_TASK_FOR_USER_TEAM, {
          headers: {
        ...
        <Grid item xs={12} md={6} sm={8}>
          ...
          >
                        ...
                        <Grid container sx={{ m: 1.5 }}>
                          ...
                          <Grid item md={6} lg={6} xs={6} sm={6}>
                            ...
                            <Tooltip title={exercise.employeenameto?.length > 10 ? exercise.employeenameto : ''}>
                              ...
                              >
                                {exercise.employeenameto?.length > 10 ? `${exercise.employeenameto.substring(0, 10)}...` : exercise.employeenameto}
                              </Typography>
                            </Tooltip>
                          ...
                          <Grid item md={4} lg={4} xs={4} sm={4}>
                            <Typography variant="subtitle2" sx={{ color: '#f2783a', fontWeight: 'bold', fontSize: '11px' }}>
                              {exercise.assetmaterial}
                            </Typography>
                            <Chip
                              sx={{
                                height: '20px',
            ...
            <Grid container sx={{ justifyContent: 'flex-end', marginTop: 'auto' }}>
              <Link to="/mymaintenanceteamlist" target="_blank">
