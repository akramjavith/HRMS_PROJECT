...
function Nonproductionunitallot() {
    ...
    const fetchEmployeeOverall = async () => {
        ...
        try {
            ...
            setAssignedbyOverall(res_employee?.data?.result?.map((item, index) => ({
                ...item,
    ...
    const fetchEmployee = async () => {
        ...
        try {
            ...
            setAssignedby(res_employee?.data?.result?.map((item, index) => ({
                ...item,
    ...
    const handleResetSearch = async () => {
        ...
        try {
            ...
            setAssignedby(res_vendor?.data?.result?.map((item, index) => ({
                ...item,
                serialNumber: (page - 1) * pageSize + index + 1
            })));
