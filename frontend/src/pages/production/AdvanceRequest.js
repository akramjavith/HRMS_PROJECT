...
import {
    Box, Button, Checkbox, Dialog, DialogActions, Tooltip, InputAdornment, Radio,
    RadioGroup, DialogContent, FormControl, FormControlLabel, Grid, IconButton, List, ListItem, ListItemText, MenuItem, OutlinedInput, Popover, Select, TextareaAutosize, TextField, Typography
} from "@mui/material";
...
function AdvanceRequest() {
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("Advance Request List"),
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "Advance Request List.png");
                })
                .catch((error) => {
  ...
  `;
        ...
        },
        {
            ...
            cellRenderer: (params) => (
                <Grid sx={{ display: "flex" }}>
                    {/* {isUserRoleCompare?.includes("dadvancerequest") && (
                        <Button
                    ...
                    {isUserRoleCompare?.includes("vadvancerequest") && (
                        <Button
                    ...
                    {/* {((isUserRoleAccess?.role?.includes("Manager") || isUserRoleAccess?.role?.includes("HiringManager") || isUserRoleAccess?.role?.includes("HR") || isUserRoleAccess?.role?.includes("Superadmin")) && ["Approved", "Rejected"].includes(params.data.status)) ||
                        (isUserRoleCompare?.includes("iadvancerequest") && (
                            <Button
                                sx={userStyle.buttonedit}
                                onClick={() => {
    ...
    return (
        <Box>
            <Headtitle title={"ADVANCE REQUEST"} />
            <PageHeading
                title="Advance Request"
                modulename="PayRoll"
                submodulename="Loan & Advance"
                mainpagename="Advance Request"
                subpagename=""
                subsubpagename=""
            />
            ...
            <br />
            {/* ****** Table Start ****** */}
            {isUserRoleCompare?.includes("ladvancerequest") && (
                <>
                    <Box sx={userStyle.container}>
                        {/* ******************************************************EXPORT Buttons****************************************************** */}
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>Advance Request List</Typography>
                        </Grid>
                        <br />
                        <Grid container spacing={2} style={userStyle.dataTablestyle}>
                            ...
                            <Grid item md={8} xs={12} sm={12} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                                <Box>
                                    {isUserRoleCompare?.includes("exceladvancerequest") && (
                                        <>
                                            <Button onClick={(e) => {
                                    ...
                                    {isUserRoleCompare?.includes("csvadvancerequest") && (
                                        <>
                                            <Button onClick={(e) => {
                                                setIsFilterOpen(true)
                                                // fetchAllGroupArray()
                                    ...
                                    {isUserRoleCompare?.includes("printadvancerequest") && (
                                        <>
                                    ...
                                    {isUserRoleCompare?.includes("pdfadvancerequest") && (
                                        <>
                                    ...
                                    {isUserRoleCompare?.includes("imageadvancerequest") && (
                                        <>
