...
function BiometricExitReport() {
    ...
    const [exitReportArray, setExitReportArray] = useState([]);
    const {
        isUserRoleCompare,
        isUserRoleAccess,
        isAssignBranch,
    ...
    useEffect(() => {
        addSerialNumber(exitReportArray);
    }, [exitReportArray]);
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("BiometricExitReport"),
    ...
    const sendRequest = async () => {
        ...
        try {
            const response = await axios.post(SERVICE.BIOMETRIC_USERS_EXIT_REPORT, {
                headers: {
                    Authorization: `Bearer ${auth.APIToken}`,
                },
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "BiometricExitReport.png");
                })
                .catch((error) => {
    ...
    // Excel
    const fileName = "BiometricExitReport";

    //print...
    const componentRef = useRef();
    const handleprint = useReactToPrint({
        content: () => componentRef.current,
        documentTitle: "Biometric Exit Report",
        pageStyle: "print",
    });
    ...
    return (
        <Box>
            ...
            <PageHeading
                ...
                subsubpagename="Biometric Exit Report"
            />
            {isUserRoleCompare?.includes("lbiometricexitreport") && (
                <>

                    <Box sx={userStyle.selectcontainer}>
                        <Typography sx={userStyle.importheadtext}>Biometric Exit Report Filter</Typography>
                        <br />
                        <>
                ...
                <>
                    <Box sx={userStyle.container}>
                        ...
                        <Grid container spacing={2} style={userStyle.dataTablestyle}>
                            <Grid item md={2} xs={12} sm={12}>
                                <Box>
                                    ...
                                    >
                                        ...
                                        <MenuItem value={exitReportArray?.length}>All</MenuItem>
                                    </Select>
                                </Box>
                            </Grid>
                            <Grid
                            ...
                            >
                                <Box>
                                    {isUserRoleCompare?.includes("excelbiometricexitreport") && (
                                        <>
                                            <Button
                                                onClick={(e) => {
                                    ...
                                    {isUserRoleCompare?.includes("csvbiometricexitreport") && (
                                        <>
                                            <Button
                                                onClick={(e) => {
                                                    setIsFilterOpen(true);
                                    ...
                                    {isUserRoleCompare?.includes("printbiometricexitreport") && (
                                        <>
                                    ...
                                    {isUserRoleCompare?.includes("pdfbiometricexitreport") && (
                                        <>
                                            <Button
                                                sx={userStyle.buttongrp}
                                                onClick={() => {
                                    ...
                                    {isUserRoleCompare?.includes("imagebiometricexitreport") && (
                                        <Button
                                            sx={userStyle.buttongrp}
                            ...
                            <Grid item md={2} xs={6} sm={6}>
                                ...
                                <AggregatedSearchBar
                                    ...
                                    setPage={setPage}
                                    maindatas={exitReportArray}
                                    setSearchedString={setSearchedString}
                                    searchQuery={searchQuery}
                                    setSearchQuery={setSearchQuery}
                                    paginated={false}
                                    totalDatas={exitReportArray}
            ...
            <ExportData
                ...
                itemsTwo={exitReportArray ?? []}
                filename={"Biometric Exit Report"}
...
export default BiometricExitReport;