...
function ConsolidatedSalary() {
  ...
  const fetchCompanies = async () => {
    setIsActive(true);
    try {
      const [RES_COM, RES_BRANCH, RES_USERS, RES_UNIT, RES_DESIG, RES_TEAMS, RES_TAX, RES_SHIFT, RES_SALARYSLAB, RES_SHORTAGE, RES_ERA, RES_REVENUE, RES_ACPOINT, RES_PAYRUNCONTROL, RES_ATTSTS, RES_ATTMODE
      ] = await Promise.all([
        ...
        if (res.data.users.length > 0) {
          ...
          getAllResults().then(results => {
            ...
            function processEmployeeItem(item, index, data) {
              ...
              let PF_Emper_deduction = pfAmount1 > 0 ? (finalBasicValCalc / totalshiftCalcVal) * pfDaysVal * (pfAmount1 / 100) : 0;
              ...
              PF_Emper_deduction = pfAmount1 > 0 ? (finalBasicValCalc / totalshiftCalcVal) * pfDaysVal * (pfAmount1 / 100) : 0;
              // // let pfEmployerDeductionCalc = PF_Emper_deduction
              //ESI-DEDCUTION
              ...
              let Fixed_PF_Emper_deduction = FixedpfAmount1 > 0 ? (Fixed_Basic_CalcVal / totalshiftCalcVal) * pfDaysVal * FixedpfAmount1 : 0;
              // // let pfEmployerDeductionCalc = PF_Emper_deduction
              //ESI-DEDCUTION
              ...
              Fixed_PF_Emper_deduction = FixedpfAmount1 > 0 ? ((Fixed_Basic_CalcVal / totalshiftCalcVal) * pfDaysVal) * FixedpfAmount1 : 0;
              ...
              // let  PROD_Shift_Allowance = (1000 / totalNoOfDaysCalcVal) * (findPointsDetails ? Number(findPointsDetails.noallowancepoint) : 0);

              let PROD_Shift_Allowance = ((1000 / totalNoOfDaysCalcVal) * (findPointsDetails ? Number(findPointsDetails.noallowancepoint) : 0) * (allowancepointCalcVal > 0 ? (allowancepointCalcVal * 100) / targetPointCalcVaue : 0)) / 100;
              ...
              PROD_PF_Emper_deduction = PRODpfAmount1 > 0 ? ((PROD_BASIC_ValCalc / totalshiftCalcVal) * pfDaysVal) * PRODpfAmount1 : 0;
              ...
              PROD_Shift_Allowance = ((1000 / totalNoOfDaysCalcVal) * (findPointsDetails ? Number(findPointsDetails.noallowancepoint) : 0) * (allowancepointCalcVal > 0 ? (allowancepointCalcVal * 100) / targetPointCalcVaue : 0)) / 100;
  ...
  // Excel
  const fileName = "Final Salary List";
  ...
  const columnDataTable = [
    ...
    { field: "uan", headerName: "UAN", flex: 0, width: 100, hide: !columnVisibility.uan, headerClassName: "bold-header" },
    { field: "ipname", headerName: "IP Name", flex: 0, width: 140, hide: !columnVisibility.ipname, headerClassName: "bold-header" },
    ...
    { field: "finalvaluestatus", headerName: "Final Value Status", flex: 0, width: 120, hide: !columnVisibility.finalvaluestatus, headerClassName: "bold-header" },
    ...
    { field: "fixedempptax", headerName: "Fixed Emp_ptax", flex: 0, width: 100, hide: !columnVisibility.fixedempptax, headerClassName: "bold-header" },
          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table" id="usertable" ref={componentRef}>
            <TableHead>
              <TableRow>
                ...
                {/* PRODUCTION */}
                <TableCell>PROD Loss Deduction</TableCell>
                <TableCell>PROD Net Salary</TableCell>
                <TableCell>PROD Basic</TableCell>
                <TableCell>PROD HRA</TableCell>
                <TableCell>PROD Conveyance</TableCell>
                <TableCell>PROD Medical Allowance</TableCell>
                <TableCell>PROD Production Allowance</TableCell>
                <TableCell>PROD Other Allowance</TableCell>
                <TableCell>PROD Net Salary1</TableCell>
                <TableCell>PROD_Emp_pf</TableCell>
                <TableCell>PROD_Emp_esi</TableCell>
                <TableCell>PROD Emp Tax</TableCell>
                <TableCell>PROD_Emp_ptax</TableCell>
                <TableCell>PROD_Empr_pf</TableCell>
                <TableCell>PROD_Empr_Esi</TableCell>
                <TableCell>PROD Shift Allowance</TableCell>
                <TableCell>PROD Total Deductions</TableCell>
                <TableCell>PROD Salary</TableCell>
                <TableCell>PROD Salary-Penalty</TableCell>
                <TableCell>PROD LOP Days</TableCell>
                <TableCell>PROD LOP </TableCell>
                <TableCell>PROD Leave Deduction</TableCell>
                <TableCell>PROD CTC</TableCell>
                <TableCell>PROD Final Value</TableCell>
                <TableCell>PROD Actual Deduction</TableCell>
                <TableCell>PROD Minimum Deduction</TableCell>
              ...
              {rowDataTable &&
                rowDataTable.map((row, index) => (
                  <TableRow key={index}>
                    ...
                    {/* PRODUCTION */}
                    <TableCell>{row.prodlossdeduction}</TableCell>
                    <TableCell>{row.prodnetsalary}</TableCell>
                    <TableCell>{row.prodbasicp}</TableCell>
                    <TableCell>{row.prodhrap}</TableCell>
                    <TableCell>{row.prodconveyancep}</TableCell>
                    <TableCell>{row.prodmedicalallowancep}</TableCell>
                    <TableCell>{row.prodproductionallowancep}</TableCell>
                    <TableCell>{row.prodotherallowancep}</TableCell>
                    <TableCell>{row.prodnetsalaryonep}</TableCell>
                    <TableCell>{row.prodemppf}</TableCell>
                    <TableCell>{row.prodempesi}</TableCell>
                    <TableCell>{row.prodempptax}</TableCell>
                    <TableCell>{row.prodemprpf}</TableCell>
                    <TableCell>{row.prodempresi}</TableCell>
                    <TableCell>{row.prodshiftallowance}</TableCell>
                    <TableCell>{row.prodtotaldeductions}</TableCell>
                    <TableCell>{row.prodsalary}</TableCell>
                    <TableCell>{row.prodsalarypenalty}</TableCell>
                    <TableCell>{row.prodlopdays}</TableCell>
                    <TableCell>{row.fixedlopdays}</TableCell>
                    <TableCell>{row.prodlop}</TableCell>
                    <TableCell>{row.prodleavededuction}</TableCell>
                    <TableCell>{row.prodctc}</TableCell>
                    <TableCell>{row.prodfinalvalue}</TableCell>
                    <TableCell>{row.prodactualdeduction}</TableCell>
                    <TableCell>{row.prodminimumdeduction}</TableCell>
