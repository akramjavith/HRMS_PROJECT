...
function TeamProductionBasedAttendance() {
    ...
    let res= await axios.post(
                SERVICE.HIERARCHY_TEAM_ATTENDANCE_BASED_CLAIM,
                {
                    ...
                    pagename: "menuteamproductionbaseattendance",
                    listpageaccessmode: listpageaccessby,
                }
            );
            if(res.statusText === "OK"){
            let res_employee = await axios.post(
                SERVICE.TEAM_ATTENDANCE_BASED_CLAIM,
                {
                    headers: {
                        Authorization: `Bearer ${auth.APIToken}`,
                    },
                            ...
                            >
                                <Box>
                                    {isUserRoleCompare?.includes(
                                        "excelteamproductionbaseattendance"
                                    ) && (
                                            <>
                                                <Button
                                                    onClick={(e) => {
                                    ...
                                    {isUserRoleCompare?.includes(
                                        "csvteamproductionbaseattendance"
                                    ) && (
                                            <>
                                                <Button
                                                    onClick={(e) => {
                                    ...
                                    {isUserRoleCompare?.includes(
                                        "printteamproductionbaseattendance"
                                    ) && (
                                            <>
                                    ...
                                    {isUserRoleCompare?.includes(
                                        "pdfteamproductionbaseattendance"
                                    ) && (
                                            <>
                                                <Button
                                                    sx={userStyle.buttongrp}
                                    ...
                                    {isUserRoleCompare?.includes(
                                        "imageteamproductionbaseattendance"
                                    ) && (
                                            <Button
                                                sx={userStyle.buttongrp}
...
export default TeamProductionBasedAttendance;