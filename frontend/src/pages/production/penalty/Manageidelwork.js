...
function Manageidlework() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const isNameMatch = taskcategorys.some((item) => item.name.toLowerCase() == ManageIdleWorkState.name.toLowerCase() && item.appliedfor.toLowerCase() == ManageIdleWorkState.appliedfor.toLowerCase());
  ...
  const editSubmit = async (e) => {
    ...
    const isNameMatch = resdata.some((item) => item.name.toLowerCase() === ManageIdleWorkEdit.name.toLowerCase() && item.appliedfor.toLowerCase() == ManageIdleWorkEdit.appliedfor.toLowerCase());
  ...
  return (
    <Box>
      ...
      <PageHeading title="Idle Work" modulename="Production" submodulename="Non Production" mainpagename="Non-production Setup" subpagename="Idle Work Master" subsubpagename="" />
      {/* ****** Header Content ****** */}
      ...
      />
      <InfoPopup openInfo={openInfo} handleCloseinfo={handleCloseinfo} heading="Idle Work Info" addedby={addedby} updateby={updateby} />
