...
function ClientErrorWaiver() {
    ...
    let exportColumnNames = ['Ventor Name','Branch Name','Employee Code','Employee Name','Login id','Date','Category','Subcategory','Document Number','Field Name','Line','Error Value','Correct Value','Client Error','Client Amount','per%','Amount','Reason'];
    let exportRowValues = ['ventorname','branchname','employeecode','employeename','loginid','date','category','subcategory','documentnumber','fieldname','line','errorvalue','correctvalue','clienterror','clientamount','per','amount','reason'];
    
    let exportColumnNamestwo = ['Ventor Name','Branch Name','Employee Code','Employee Name','Login id','Date','Category','Subcategory','Document Number','Field Name','Line','Error Value','Correct Value','Client Error','Client Amount','per%','Amount','Reason'];
    let exportRowValuestwo = ['ventorname','branchname','employeecode','employeename','loginid','date','category','subcategory','documentnumber','fieldname','line','errorvalue','correctvalue','clienterror','clientamount','per','amount','reason'];
    ...
    const [clientError, setClientError] = useState({  fromdate: "", todate: "", });
    const [clientErrorEdit, setClienterrorEdit] = useState({ fromdate: "", todate: "",  });
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "Current Client Error.png");
                })
                .catch((error) => {
    ...
    const columnDataTabletwo = [
        ...
        },
        {
            ...
            flex: 0,
            width: 100,
            hide: !columnVisibilitytwo.reason,
            headerClassName: "bold-header",
        },
        {
            field: "actions",
    ...
    return (
        <Box>
            ...
            <PageHeading
                ...
                subsubpagename="Client Error Waiver"
            />
            {isUserRoleCompare?.includes("aclienterrorwaiver") && (
                <>
            ...
            {isUserRoleCompare?.includes("lclienterrorwaiver") && (
                ...
                <>
                    <Box sx={userStyle.container}>
                        ...
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>
                            {/* Client Error Waiver List */}
                                 Current Client Error List
                            </Typography>
                        </Grid>
                        ...
                        &ensp;
                        {isUserRoleCompare?.includes("bdclienterrorwaiver") && (
                            <Button
                                variant="contained"
            ...
            >
                <Box sx={{ width: "550px", padding: "20px 50px" }}>
                    <>
                        <Typography sx={userStyle.HeaderText}> View Client Error Waiver</Typography>
                        <br /> <br />
                        <Grid container spacing={2}>
                            <Grid item md={12} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
            ...
            <InfoPopup
                ...
                heading="Client Error Waiver Info"
                addedby={addedby}
                updateby={updateby}
            />
