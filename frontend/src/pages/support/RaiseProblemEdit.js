...
function Raiseproblem() {
  ...
  const handleSubmit = () => {
    ...
    //   (item) =>
    //     item.mode == raiseproblem.mode &&
    //     item.priority == raiseproblem.priority &&
    //     item.modulename.toLowerCase() ==
    //       (singleSelectValues.module.toLowerCase() ||
    //         raiseproblem.modulename.toLowerCase()) &&
    //     item.submodulename.toLowerCase() ==
    //       (singleSelectValues.submodule.toLowerCase() ||
    //         raiseproblem.submodulename.toLowerCase()) &&
    //     item.mainpagename.toLowerCase() ==
    //       (singleSelectValues.mainpage.toLowerCase() ||
    //         raiseproblem.mainpagename.toLowerCase()) &&
    //     item.subpagename.toLowerCase() ==
    //       (singleSelectValues.subpage.toLowerCase() ||
    //         raiseproblem.subpagename.toLowerCase()) &&
    //     item.subsubpagename.toLowerCase() ==
    //       (singleSelectValues.subsubpage.toLowerCase() ||
    //         raiseproblem.subsubpagename.toLowerCase())
    // );
    ...
    //       />
    //       <p style={{ fontSize: "20px", fontWeight: 900 }}>
    //         {"Please Enter Main Page"}
    //       </p>
    //     </>
    //   );
    //   handleClickOpenerr();
    // } else if (raiseproblem.mode === "New" && raiseproblem.subpagename === "") {
    //   setShowAlert(
    //     <>
    //       <ErrorOutlineOutlinedIcon
    //         sx={{ fontSize: "100px", color: "orange" }}
  ...
  return (
    <Box>
      <Headtitle title={"RAISE PROBLEM EDIT"} />
                ...
                <FormControl fullWidth size="small">
                  ...
                  <Selects
                    ...
                    onChange={(e) => {
                      ...
                      handleModuleNameChange(e.value, rolesNewList);
                      setMainPageoptions([]);
                      setSubPageoptions([]);
                      setsubSubPageoptions([]);
                    }}
