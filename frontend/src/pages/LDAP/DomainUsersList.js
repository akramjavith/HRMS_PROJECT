...
function DomainUsersList() {
  ...
  const getapi = async () => {
    let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
      ...
      pagename: String("Domain Users List"),
  ...
  const handleCaptureImage = () => {
    if (gridRefTableImg.current) {
      domtoimage
        ...
        .then((blob) => {
          saveAs(blob, "Domain Users List.png");
        })
        .catch((error) => {
  ...
  const handleprint = useReactToPrint({
    ...
    documentTitle: "Domain Users List",
    pageStyle: "print",
  });
  ...
  const sendRequest = async () => {
    ...
    try {
      setIsLoading(true);
      let res = await axios.post(
        `${SERVICE.CREATEUSERWITHOUBASED}`,
        {
          cn: addDetails.cn,
          sn: addDetails.sn,
          sAMAccountName: addDetails.username,
          userPassword: addDetails.password,
          ou: addDetails.ou,
        },
        {
          headers: {
  ...
  return (
    <Box>
      <NotificationContainer />
      <Headtitle title={"Domain Users List"} />
      {/* ****** Header Content ****** */}
      <PageHeading
        title="Domain Users List"
        modulename="LDAP"
        submodulename="Domain Users List"
        mainpagename=""
        subpagename=""
        subsubpagename=""
      />
      {isUserRoleCompare?.includes("adomainuserslist") && (
        <>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item md={3} xs={12} sm={12}>
                      ...
                      <FormControl size="small" fullWidth>
                        <MultiSelect
                          ...
                          onChange={(e) => {
                            handleAccountStatusChangeNew(e);
                          }}
                          valueRenderer={customValueRendererStatusNew}
                    ...
                    <Grid item md={3} xs={12} sm={12}>
                      <Typography>
                        Account Type<b style={{ color: "red" }}>*</b>
                      </Typography>
                      <FormControl size="small" fullWidth>
                        <MultiSelect
                          ...
                          labelledBy="Please Select Account Type"
                        />
                      </FormControl>
                    </Grid>
                    {!valueAccountStatusCat?.includes("Mismatched") && (
                    ...
                    <Grid item md={3} xs={12} sm={12}>
                      <FormControl fullWidth size="small">
                        ...
                        <Selects
                          ...
                          isDisabled={valueAccountStatusCat?.includes(
                            "Mismatched"
                          )}
                        />
                      </FormControl>
                      ...
                      <>
                              ...
                              <MultiSelect
                                options={allUsersData
                                  ?.filter((u) => {
                                    ...
                                    if (
                                      valueEmployementTypeCat?.length === 1 &&
                                      valueEmployementTypeCat.includes(
                                        "Internship"
                                      )
                                    ) {
                                      return (
                        ...
                        {/* <Grid item md={3} xs={12} sm={12}>
                          <FormControl fullWidth size="small">
                            ...
                            <MultiSelect
                              options={OUOptions}
                              value={selectedOptionsOU}
                              onChange={(e) => {
                                handleOUChange(e);
                              }}
                              valueRenderer={customValueRendererOU}
                              labelledBy="Please Select OU"
                            />
                          </FormControl>
                        </Grid> */}
                      </>
      ...
      {tableLoader ? (
        ...
        <>
          {isUserRoleCompare?.includes("ldomainuserslist") && (
            <>
              <Box sx={userStyle.container}>
                {/* ******************************************************EXPORT Buttons****************************************************** */}
                <Grid container spacing={2}>
                ...
                <Grid container spacing={2} style={userStyle.dataTablestyle}>
                  ...
                  >
                    <Box>
                      {isUserRoleCompare?.includes("exceldomainuserslist") && (
                        <>
                          <Button
                            onClick={(e) => {
                      ...
                      {isUserRoleCompare?.includes("csvdomainuserslist") && (
                        <>
                          <Button
                            onClick={(e) => {
                              setIsFilterOpen(true);
                      ...
                      {isUserRoleCompare?.includes("printdomainuserslist") && (
                        <>
                          <Button
                            sx={userStyle.buttongrp}
                            onClick={handleprint}
                      ...
                      {isUserRoleCompare?.includes("pdfdomainuserslist") && (
                        <>
                          <Button
                            sx={userStyle.buttongrp}
                            onClick={() => {
                      ...
                      {isUserRoleCompare?.includes("imagedomainuserslist") && (
                        <Button
                          sx={userStyle.buttongrp}
