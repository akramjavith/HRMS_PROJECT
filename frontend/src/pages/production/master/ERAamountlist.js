...
function EraAmountList() {
  ...
  const fetchFilter = async () => {
    ...
    try {
      const response = await axios.post(SERVICE.ERAAMOUNTS_FILTER, queryParams, {
        headers: {
          Authorization: `Bearer ${auth.APIToken}`,
        },
      });
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading title="ERA Amount" modulename="Production" submodulename="SetUp" mainpagename="ERA Amount List" subpagename="" subsubpagename="" />
      <br />
      ...
      />
      {/* INFO */}
      <InfoPopup openInfo={openInfo} handleCloseinfo={handleCloseinfo} heading="ERA Amount Info" addedby={addedby} updateby={updateby} />
