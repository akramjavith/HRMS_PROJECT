...
function TrainingPostponedList({ com }) {
    ...
    const ListPageLoadDataPostPoned = async () => {
        ...
        try {
            ...
            const answer = res_task?.data?.trainingforuser?.length > 0 ? res_task?.data?.trainingforuser?.map((item, index) => ({
    ...
    return (
        <Box>
            ...
            {/* ****** Header Content ****** */}
            <PageHeading
                title="User Postponed Training Panel"
                modulename="Training"
                submodulename="Training Postponed User Panel"
                mainpagename=""
                subpagename=""
                subsubpagename=""
            />
