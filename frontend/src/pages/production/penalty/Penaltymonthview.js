...
function ManagePenaltyMonthView() {
    ...
    const idviewall = open ? "simple-popover" : undefined;
    ...
    const addSerialNumberviewall = (datas) => {
        const itemsWithSerialNumber = datas?.map((item, index) => ({
            ...
            serialNumber: index + 1,
            fromdate: moment(item.fromdate).format("DD-MM-YYYY"),
            todate: moment(item.toate).format("DD-MM-YYYY"),
        }));
    ...
    const rowdatasingleview = async (id, data) => {
        ...
        try {
            ...
            const res = await axios.post(`${SERVICE.PENALTY_MONTH_VIEW_INDIVIDUAL}`, {
        ...
        <Box>
                            ...
                            <Box sx={userStyle.container}>
                                ...
                                <Grid container >
                                    ...
                                    <Grid item md={2} xs={12} sm={12}>
                                        ...
                                        <Link to={`/production/penalty/managepenaltymonth/`}>
            ...
            >
                <DialogContent sx={{ marginTop: '50px' }}>
                    <>
                        <Typography sx={userStyle.HeaderText}>{"Penalty Month Individual User"}</Typography>
                        {/* <br /> */}
            ...
            <ExportData
                ...
                filename={"Penalty Month View Individual Users"}
