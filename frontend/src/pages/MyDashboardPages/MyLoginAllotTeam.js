...
function IndividualLoginAllotList() {
  ...
  const { isUserRoleCompare,listPageAccessMode, pageName, setPageName, isUserRoleAccess } = useContext(UserRoleAccessContext);
      ...
      {isUserRoleCompare?.includes('lindividualloginallot') && (
        <>
          <Box sx={userStyle.container}>
            {/* ******************************************************EXPORT Buttons****************************************************** */}
            <Grid item xs={8}>
              <PageHeading title="Individual Login Allot List" modulename="Production" submodulename="SetUp" mainpagename="Individual Login Allot" subpagename="" subsubpagename="" />
            </Grid>
            <br />
            ...
            {rowDataTable &&
              rowDataTable.map((row, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell>{row.empcode === undefined ? '' : row.empcode}</TableCell>
