...
import AssignedUsername from "./AssignedUsername";
...
function CompanyEmailsList() {

  let exportColumnNames = ['Company', 'Branch', 'Unit', 'Department', 'Team', 'Work Mode', 'Emp Code', 'Name', 'Username', 'Email', 'Company Email'];
  let exportRowValues = ['company', 'branch', 'unit', 'department', 'team', 'workmode', 'empcode', 'companyname', 'username', 'email', 'companyemail'];
  ...
  const getapi = async () => {
    let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
      ...
      pagename: String("Company Emails List"),
  ...
  const columnDataTable = [
        ...
        <>
          {params?.value === "Created" ? <>
            <div style={{ padding: '0 10px 10px 0' }}>
              <Button sx={{ backgroundColor: 'green', color: '#fff', borderRadius: '20px' }}>
                {params?.value}
              </Button>
            ...
            <div style={{ padding: '0 10px 10px 0' }}>
              <Button sx={{ backgroundColor: 'red', color: '#fff', borderRadius: '20px' }}>
                {params?.value}
              </Button>
            </div>
          </>}
    ...
    },
    {
      ...
      cellRenderer: (params) => (
        <Grid sx={{ display: "flex" }}>
          {isUserRoleCompare?.includes("vcompanyemailuserslist") && (
            <Button
  ...
  return (
    <Box>
      ...
      <PageHeading
        ...
        subsubpagename="Company Email Users List"
      />
      <br />
      {isUserRoleCompare?.includes("acompanyemailuserslist") && (
        <>
      ...
      <br />
      {isUserRoleCompare?.includes("lcompanyemailuserslist") && (
        <>
          <Box sx={userStyle.container}>
            ...
            <Grid container spacing={2} style={userStyle.dataTablestyle}>
              ...
              >
                <Box>
                  {isUserRoleCompare?.includes("excelcompanyemailuserslist") && (
                    <>
                      <Button
                        onClick={(e) => {
                  ...
                  {isUserRoleCompare?.includes("csvcompanyemailuserslist") && (
                    <>
                      <Button
                        onClick={(e) => {
                          setIsFilterOpen(true);
                  ...
                  {isUserRoleCompare?.includes("printcompanyemailuserslist") && (
                    <>
                  ...
                  {isUserRoleCompare?.includes("pdfcompanyemailuserslist") && (
                    <>
                      <Button
                        sx={userStyle.buttongrp}
                        onClick={() => {
                  ...
                  {isUserRoleCompare?.includes("imagecompanyemailuserslist") && (
      ...
      <Dialog open={openview} onClose={handleClickOpenview} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description" maxWidth="md" fullWidth={true} sx={{ marginTop: '50px' }}>
        <Box sx={{ padding: "20px 50px" }}>
          <>
            <Typography sx={userStyle.HeaderText}> View Company Email Details</Typography>
            <br /> <br />
            <Grid container spacing={2}>
              ...
              <Grid item md={6} xs={12} sm={12}>
                <FormControl fullWidth size="small">
                  ...
                  <Typography>{empaddform.companyemail}</Typography>
                </FormControl>
              </Grid>
              <Grid item md={6} xs={12} sm={12}>
                <FormControl fullWidth size="small">
...
export default CompanyEmailsList;
