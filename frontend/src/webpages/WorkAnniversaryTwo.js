    ...
    const fetchEmployeeDob = async (id) => {
        try {
            ...
            ${!availedData?.carea ? "" : availedData?.carea + ","}
                ...
                return availedData?.doj === "" || availedData?.doj === undefined ? "" : availedData?.doj;
                    ...
                    <div id="twoempprofile">
                        <div id="emponediv">
                            <div id="weddingImgtwo2nos" >
                                ...
                                <span className="weddingdobtwo2nos">{employeeOneDobYr === "" || employeeOneDobYr === undefined || employeeOneDobYr === "undefined" ? "" : employeeOneDobYr}</span>
                            </div>
                        ...
                        <div id="emptwodiv">
                            <div id="profileImgweddingtwo2nos" >
                                ...
                                <span className="weddingdobtwotwo2nos">{employeeTwoDobYr === "" || employeeTwoDobYr === undefined || employeeTwoDobYr === "undefined" ? "" : employeeTwoDobYr}</span>
                            </div>
...
export default WorkAnniversaryTwo;