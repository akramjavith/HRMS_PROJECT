...
function ListOfDocument() {
    ...
    const fetchListofdocument = async () => {
        ...
        } catch (err) {setListofdocumentcheck(true);handleApiError(err, setShowAlert, handleClickOpenerr);}
    }
    ...
    return (
        <Box>
            ...
            {/* ****** Header Content ****** */}
            <Typography sx={userStyle.HeaderText}>List of Document</Typography>
