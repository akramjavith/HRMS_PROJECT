...
function WaiverEmployeeForward() {
    ...
    const sendRequest = async () => {
        ...
        try {
            let grpcreate = await axios.post(SERVICE.GROUP_CREATE, {
                ...
                name: String(waiverEmployee.name),
                addedby: [
                    {
            ...
            setWaiverEmployee(grpcreate.data);
            await fetchAllClient();
            setWaiverEmployee({ name: "" });
    ...
    const getCode = async (e, name) => {
        ...
        try {
            ...
            handleClickOpenEdit();
            setWaiverEmployeeEdit(res?.data?.sgroup);
        } catch (err) {
            handleApiError(err, setPopupContentMalert, setPopupSeverityMalert, handleClickOpenPopupMalert);
        }
    };
    ...
    let updateby = waiverEmployeeEdit.updatedby;
    let addedby = waiverEmployeeEdit.addedby;
    let projectsid = waiverEmployeeEdit._id;
    ...
    const sendEditRequest = async () => {
        ...
        try {
            let res = await axios.put(`${SERVICE.GROUP_SINGLE}/${projectsid}`, {
                ...
                name: String(waiverEmployeeEdit.name),
                updatedby: [
                    ...updateby,
                    {
                        name: String(isUserRoleAccess.companyname),
            ...
            setWaiverEmployeeEdit(res.data);
    ...
    return (
        <Box>
            ...
            />
            {isUserRoleCompare?.includes("awaiveremployeeforward") && (
                <>
                        ...
                        <>
                            ...
                            <Grid item md={4} xs={12} sm={6}>
                                    ...
                                    <Typography>
                                        ...
                                        <Selects
                                            value={{ label: waiverEmployee.modeone, value: waiverEmployee.modeone }}
                                            onChange={((e) => {
                                                setWaiverEmployee({
                                                    ...waiverEmployee,
                                                    modeone: e.value,
                                ...
                                <Grid item md={4} xs={12} sm={6}>
                                    ...
                                    <Typography>
                                        ...
                                        <Selects
                                            value={{ label: waiverEmployee.levelmode, value: waiverEmployee.levelmode }}
                                            onChange={((e) => {
                                                setWaiverEmployee({
                                                    ...waiverEmployee,
                                                    levelmode: e.value,
                                    ...
                                    <Grid item md={12} xs={12} sm={6}>
                                        <FormControl fullWidth size="small">
                                            ...
                                            <OutlinedInput
                                                ...
                                                value={waiverEmployeeEdit.name}
                                                onChange={(e) => {
                                                    setWaiverEmployeeEdit({ ...waiverEmployeeEdit, name: e.target.value });
                                                }}
                                            />
                                        </FormControl>
                                    </Grid>
            ...
            >
                <Box sx={{ width: "550px", padding: "20px 50px" }}>
                    <>
                        <Typography sx={userStyle.HeaderText}> View Waiver Employee Forward</Typography>
                        <br /> <br />
                        <Grid container spacing={2}>
                            <Grid item md={12} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    <Typography variant="h6">Name</Typography>
                                    <Typography>{waiverEmployeeEdit.name}</Typography>
                                </FormControl>
                            </Grid>
                        </Grid>
                        <br /> <br /> <br />
            ...
            <InfoPopup
                ...
                heading="Waiver Employee Forward Info"
                addedby={addedby}
                updateby={updateby}
            />
