...
function Nonproductionunitrate() {
  ...
  const sendRequest = async () => {
    ...
    try {
      let subprojectscreate = await axios.post(
        SERVICE.NONPRODUCTIONUNITRATE_CREATE,
        {
  ...
  const fetchCategoryDropdown = async () => {
    ...
    try {
      ...
      setCategories(
        resCategory.data.categoryandsubcategory.map((data) => ({
  ...
  const handleCategoryChange = async (e) => {
    ...
    try {
      ...
      const CatOpt = [
        ...resCategory?.data?.categoryandsubcategory?.map((t) => ({
          ...t,
  ...
  const fetchNonProductionUnitRateOverall = async () => {
    ...
    try {
      ...
      setNonProductionUnitRateListOverall(
        res_vendor?.data?.nonproductionunitrate.map((item, index) => {
          return {
            id: item._id,
  ...
  const fetchNonProductionUnitRate = async () => {
    ...
    try {
      let res_vendor = await axios.post(SERVICE.NONPRODUCTIONUNITRATEGETALL_PAGINATION, queryParams, {
        headers: {
          Authorization: `Bearer ${auth.APIToken}`,
        },
      });
                    ...
                    <Grid item md={4} xs={12} sm={12}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput
                          ...
                          type="text"
                          inputMode="decimal"
                          disabled={nonProductionUnitRate.process != "Day"}
                          pattern="[0-9]*"
                    ...
                    <Grid item md={4} xs={12} sm={12}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput
                          ...
                          inputMode="decimal"
                          pattern="[0-9]*"
                          disabled={nonProductionUnitRate.process != "Hours"}
                    ...
                    <Grid item md={4} xs={12} sm={12}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput
                          ...
                          inputMode="decimal"
                          pattern="[0-9]*"
                          disabled={nonProductionUnitRate.process != "Mins"}
