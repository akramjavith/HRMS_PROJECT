...
function Erroruploadconfirm() {
    ...
    const exportColumnNames = [
        ...
        'Project Vendor', 'Date',
        'Queue Name', 'Login ID',
        'Accuracy', 'Total Fields', 'Error Count', 'Auto Count', 'Manual Total', 'Manual Error', 'Upload Count', 'Level'
    ]
    const exportRowValues = [
        'companyname', 'branchname', 'unitname',
        'projectvendor', 'date',
        'queuename', 'loginid',
        'accuracy', 'totalfields', 'errorcount', 'autocount', 'manualtotal', 'manualerror', 'Manual Error', 'uploadcount', 'level'
    ]
    ...
    const exportColumnNamesnot = [
        ...
        'Project Vendor', 'Date',
        'Queue Name', 'Login ID',
        'Accuracy', 'Total Fields', 'Error Count', 'Auto Count', 'Manual Error', 'Upload Count', 'Level'
    ]
    const exportRowValuesnot = [
        'companyname', 'branchname', 'unitname',
        'projectvendor', 'date',
        'queuename', 'loginid',
        'accuracy', 'totalfields', 'errorcount', 'autocount', 'manualerror', 'uploadcount', 'level'
    ]
                    ...
                    {isUserRoleCompare?.includes("emanualerrorupdate") && (
                        <Grid sx={{ display: "flex" }}>
                            ...
                            <Button
                                ...
                                size="small"
                                onClick={() => {
                                    sendEditRequestNotCompleted(params.data.id, params.data.manualerror, "manualerror");
                                }}
                            >
                                UPDATE
                            </Button>
    ...
    const fetchBatchFilter = async () => {
        ...
        try {
            let [res_employee, res_completed] = await Promise.all([
                ...
                axios.post(
                    SERVICE.ERROR_UPLOAD_CONFIRM_HIERARCHY_COMPLETED,
                    {
                        headers: {
                            Authorization: `Bearer ${auth.APIToken}`,
                        },
    ...
    const sendEditRequest = async (id, manualvalue, type, manualerror) => {
    ...
    const sendEditRequestNotCompleted = async (id, manualvalue, type) => {
        // console.log(manualvalue, "manualvalue")
        // setLoader(true)
        let editid = id;
        setPageName(!pageName)
