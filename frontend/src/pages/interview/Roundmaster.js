...
function Roundmaster() {
  ...
  // pdf.....
  const columns = [{ title: "Round Name", field: "nameround" }];
  ...
  const sendRequest = async () => {
    ...
    try {
      ...
      await fetchRoundmaster();
      setRoundmaster({ ...roundmaster, nameround: "" });
      setShowAlert(
        <>
              ...
              {rowDataTable &&
                rowDataTable.map((row, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell>{row.nameround}</TableCell>
                  </TableRow>
                ))}
            </TableBody>
          </Table>
