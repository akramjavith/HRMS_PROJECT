...
function ManagePenaltyMonth() {
    ...
    const handleSubmit = async (e) => {
        ...
        const givenDate = new Date(managepenaltymonth.todate);
    ...
    const getCode = async (id, data) => {
        ...
        try {
            ...
            //     id: e,
            // });
            const res = await axios.post(`${SERVICE.PENALTY_MONTH_VIEW}`, {
                fromdate: data.fromdateold,
                todate: data.todateold,
            ...
            cellRenderer: (params) => (
                <Grid sx={{ display: "flex" }}>
                    ...
                    {isUserRoleCompare?.includes("dpenaltymonth") && (
                        <>
                            <Button variant="contained" sx={userStyle.buttondelete} onClick={(e) => { rowData(params.data.id, params.data) }}><DeleteOutlineOutlinedIcon style={{ fontsize: 'large' }} /></Button>
                        </>
                    )}
                </Grid>
            ),
