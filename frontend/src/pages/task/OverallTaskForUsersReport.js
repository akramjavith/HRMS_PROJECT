...
function OverallTaskForUsersReport({ com }) {
    ...
    const handleprint = useReactToPrint({
        ...
        documentTitle: "User Task Panel-Overall Report",
        pageStyle: "print",
    });
    ...
    const ListPageLoadDataOnprogress = async () => {
        ...
        try {
            ...
            let res_task = await axios.post(SERVICE.ALL_TASKFORUSER_OVERALL_REPORTS, queryParams, {
                headers: {
                    Authorization: `Bearer ${auth.APIToken}`,
                },
    ...
    return (
        <Box>
            <Headtitle title={"USER TASK PANEL - OVERALL REPORTS"} />
            {/* ****** Header Content ****** */}
            <PageHeading
                title="User Task Panel - Overall Reports"
                modulename="Task"
                submodulename="Overall Task Users Report"
                mainpagename=""
                subpagename=""
                subsubpagename=""
            />
            ...
            <Box sx={userStyle.dialogbox}>
                <>
                    <Typography sx={userStyle.SubHeaderText}> User Task Panel - Overall Reports</Typography>
                    <br />
                    <br />
                    <br />
                    {isUserRoleCompare?.includes("loveralltaskusersreport") && (
                        <>
                    ...
                    {isUserRoleCompare?.includes("loveralltaskusersreport") && (
                        <>
                            <Grid container spacing={2} style={userStyle.dataTablestyle}>
                                ...
                                >
                                    {isUserRoleCompare?.includes("exceloveralltaskusersreport") && (
                                    ...
                                    {isUserRoleCompare?.includes("csvoveralltaskusersreport") && (
                                    ...
                                    {isUserRoleCompare?.includes("printoveralltaskusersreport") && (
                                        <>
                                    ...
                                    {isUserRoleCompare?.includes("pdfoveralltaskusersreport") && (
                                    ...
                                    {isUserRoleCompare?.includes("imageoveralltaskusersreport") && (
            ...
            <ExportData
                ...
                filename={"Task User Panel Overall Reports"}
...
export default OverallTaskForUsersReport;