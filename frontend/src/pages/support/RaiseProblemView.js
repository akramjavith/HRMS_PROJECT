...
function RaiseProblemView() {
  ...
  const renderFilePreviewMulterUploadedForTodo = async (file) => {
    console.log(file, "file")
    if (file.filename) {
      if (!file) return false;
      const imageUrl = `${SERVICE.VEIW_SUPPORT_FILES}/${file.filename}`;
                            ...
                            <Grid item md={2} sm={2} xs={2}>
                              ...
                              >
                                ...
                                <img
                                  ...
                                  src={getFileIcon(file.name || file.file.name)}
                                  height="25"
                                  alt="file icon"
                                />
                                {/* )} */}
                            ...
                            <Grid item md={2} sm={2} xs={2}>
                              ...
                              >
                                <VisibilityOutlinedIcon
                                  ...
                                  onClick={() => renderFilePreviewMulterUploadedForTodo(file)}
                                />
                              </Button>
                            </Grid>
                          </Grid>
