...
function OnProgressTimeStudyList({ projmaster, loading, fetchPendingOnProgress }) {
  ...
  return (
    <Box>
      ...
      <ExportData
        ...
        itemsTwo={projmaster ?? []}
        filename={"Manual Entry TimeStudy List"}
...
export default OnProgressTimeStudyList;
