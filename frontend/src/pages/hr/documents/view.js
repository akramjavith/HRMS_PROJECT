                ...
                <Grid container spacing={2} >
                    ...
                    <Grid item md={12} sm={12} xs={12}  >
                        ...
                        <Grid sx={{ display: 'flex', justifyContent: 'center', }}>
                            {origin === "overalldocumentlist" ? <><Button sx={buttonStyles.btncancel} onClick={() => { backPage('/overalllistdocument') }}>Back</Button></>
                                : <><Button sx={buttonStyles.btncancel} variant="contained" onClick={() => { backPage('/listdocument') }}> Back</Button></>}
