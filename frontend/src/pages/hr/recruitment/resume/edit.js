...
function ResumeEdit() {
  ...
  const educationTodo = () => {
    if (
      ...
      setShowAlert("Please Select Specialization");
      handleClickOpenerr();
  ...
  const handleSubmit = (e) => {
    ...
    if (addcandidateEdit.firstname == "") {
      ...
      setShowAlert("Please Select Gender");
      handleClickOpenerr();
    } else if (
      ...
      setShowAlert("Please Enter Current Salary");
      handleClickOpenerr();
    } else {
      fetchAllCandidates();
      // sendRequest();
  ...
  const fetchAllCandidates = async () => {
    ...
    try {
      ...
      if (foundData) {
        ...
        if (foundDataNew) {
          setShowAlert("Email Already Exist!");
          handleClickOpenerr();
        } else {
          ...
          if (foundDataMob) {
            setShowAlert("Mobile Already Exist!");
            handleClickOpenerr();
          } else {
            let foundDataadhaar;
            if (
            ...
            console.log(addcandidateEdit.adharnumber);

            if (foundDataadhaar) {
              setShowAlert("Aadhar Already Exist!");
              handleClickOpenerr();
            } else {
              let foundDataPan;
              if (
              ...
              if (foundDataPan) {
                setShowAlert("Pan Number Already Exist!");
                handleClickOpenerr();
              } else {
                sendRequest();
              }
  ...
  const handleAdhar = (e) => {
    if (e.length > 12) {
      setShowAlert("Adhar number can't more than 12 characters!");
      handleClickOpenerr();
  ...
  const handlepan = (e) => {
    if (e.length > 10) {
      setShowAlert("Pan number can't more than 10 characters!");
      handleClickOpenerr();
      let num = e.slice(0, 10);
          ...
          >
            ...
            <Grid item lg={1} md={2} sm={2} xs={12}>
              <Grid item lg={12} md={12} sm={12} xs={12}>
                ...
                <Button sx={userStyle.btncancel} onClick={handleCloseerrupdate}>
                  cancel
                </Button>
                {/* </Link> */}
              </Grid>
