          ...
          ...new Set(
            interviewQuestonOrderData?.filter(
              (data) =>
                ...
                data.subcategory?.some((subCat) => singelData?.subcategory?.includes(subCat))
            )
          ),
        ]);
        ...
        `${SERVICE.CANDIDATES_SINGLE}/${meetingValues[3]}`,
        {
          ...
          interviewrounds: [
            ...candidateSingle?.interviewrounds,
            {
              ...
              roundsubcategory: (Array.isArray(interviewgrouping?.subcategory) && interviewgrouping?.subcategory?.length > 0) ? interviewgrouping?.subcategory : [],
