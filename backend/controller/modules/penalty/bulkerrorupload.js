...
exports.getAllBulkErrorUploadpointsFilename = catchAsyncErrors(async (req, res, next) => {
    ...
    try {
        ...
        }, { projectvendor: 1, process: 1, loginid: 1, date: 1, dateformatted: 1, mode: 1, errorfilename: 1, documentnumber: 1, documenttype: 1, fieldname: 1, line: 1, errorvalue: 1, correctvalue: 1, link: 1, doclink: 1 });
    } catch (err) {
        return next(new ErrorHandler("Records not found!", 404));
    }
    if (!bulkerroruploadpoints) {
