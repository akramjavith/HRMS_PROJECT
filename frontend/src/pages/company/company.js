...
function Company() {
  ...
  return (
    <Box>
      ...
      <PageHeading title="Company" modulename="Setup" submodulename="Company" mainpagename="" subpagename="" subsubpagename="" />
      {/* ****** Header Content ****** */}
                  ...
                  <FormControl fullWidth size="small">
                    ...
                    <OutlinedInput
                      ...
                      onChange={(e) => {
                        ...
                        setAreatid({ ...areatid, code: filtered });
                      }}
                    />
                  </FormControl>
                </Grid>
      ...
      />
      {/* INFO */}
      <InfoPopup openInfo={openInfo} handleCloseinfo={handleCloseinfo} heading="Company Info" addedby={addedby} updateby={updateby} />
