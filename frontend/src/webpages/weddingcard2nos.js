                    ...
                    <div id="twoempprofile">
                        <div id="emponediv">
                            <div id="weddingImgtwo2nos" >
                                ...
                                <span className="weddingdobtwo2nos">{employeeOneDob === "" ? "" : moment(employeeOneDob)?.format("DD-MM-YYYY")}</span>
                            </div>
                        ...
                        <div id="emptwodiv">
                            <div id="profileImgweddingtwo2nos" >
                                ...
                                <span className="weddingdobtwotwo2nos">{employeeTwoDob === "" ? "" :moment(employeeTwoDob)?.format("DD-MM-YYYY")}</span>
                            </div>
