...
function Stockmaster({ sendDataToParentUIStock, frequencyValue, openpop, stockmaterialedit,
  handleCloseviewalertvendorstock, vendorNew, vendorGroup, stockManagehand, handover }) {
