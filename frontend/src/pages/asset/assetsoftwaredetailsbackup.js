...
function AssetSoftwareDetails() {
    ...
    const fetchAssetDetails = async (code, e) => {
        try {
            ...
            setAssetdetail({
                ...
                assetsoftwarematerial: e.assetmaterial, type: "Please Select Type",
    ...
    return (
        <Box>
            ...
            <PageHeading
                title="Dynamic Asset Master"
                modulename="Dynamic Asset Master"
            ...
            {isUserRoleCompare?.includes("adynamicassetmaster") && (
                <Box sx={userStyle.dialogbox}>
                    <Grid container spacing={2}>
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>
                                <b>Add Dynamic Asset Master </b>
                            </Typography>
                        </Grid>
                    </Grid>
                    <br />
