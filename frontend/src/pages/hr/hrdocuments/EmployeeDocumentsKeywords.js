    ...
    <Box>
      ...
      {isUserRoleCompare?.includes("lemployeedocumentskeywords") && (
        <Box sx={userStyle.container}>
          ...
          <br />
          <Typography sx={userStyle.importsubheadtex}>Follow the instructions carefully before Creating Template - <b>EMPLOYEE DOCUMENTS</b></Typography>
          <br />
          <TableContainer
            component={Paper}
            sx={{
            ...
            <Table md={{ minWidth: 200, maxHeight: "5px", overflow: "auto" }} aria-label="customized table">
              ...
              <TableBody>
                ...
                <StyledTableRow>
                  ...
                  <StyledTableCell align="left">
                    <Box sx={{ display: "flex", gap: "2px" }}>
                      <Typography sx={userStyle.importTabledata}>$EMPLOYEESIGNATURE$</Typography>
                    </Box>{" "}
                  </StyledTableCell>
                  <StyledTableCell align="left">
                    {" "}
                    <Typography sx={userStyle.importTabledata}>It denotes the Employee's Signature.</Typography>
                  </StyledTableCell>
                </StyledTableRow>
              </TableBody>
            </Table>
