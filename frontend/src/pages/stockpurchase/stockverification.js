...
//   };
  ...
  const delProject = async () => {
    try {
      ...
      await fetchStock("Filtered", searchQuery);
      handleCloseMod();
  ...
  const [isfilteroverall, setIsfitleroverall] = useState(false)
  ...
  return (
    <>
      ...
      >
        ...
        <Box>
          {/* ALERT DIALOG */}
          <Dialog open={isMove} onClose={handleCloseModMove} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
            <DialogContent sx={{ width: "350px", textAlign: "center", alignItems: "center" }}>
              <ErrorOutlineOutlinedIcon sx={{ fontSize: "80px", color: "orange" }} />
              <Typography variant="h5" sx={{ color: "red", textAlign: "center" }}>
                Are you sure you want to continue with the Move To request?
              </Typography>
            </DialogContent>
            <DialogActions>
              <Button onClick={handleCloseModMove} variant="outlined">
                Cancel
              </Button>
              <Button autoFocus variant="contained" color="primary" onClick={() => SendRequestUpdateBalance()}>
                {" "}
                OK{" "}
              </Button>
            </DialogActions>
