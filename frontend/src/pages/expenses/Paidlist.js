...
function Paidlist() {
  ...
  const fetchPaidList = async () => {
    ...
    try {
      ...
      let filteredexpenses = res1.data.expenses.filter((data) => {
        return data.billstatus === "Completed";
      });
  ...
  return (
    <Box>
      <Headtitle title={"PAID LIST"} />
      <PageHeading
        title="Manage Paid List"
        modulename="Expenses"
        submodulename="Paid List"
        mainpagename=""
        subpagename=""
        subsubpagename=""
      />
      ...
      {!loader ? (
        ...
        <>
          {/* ****** Table Start ****** */}
          {isUserRoleCompare?.includes("lpaidlist") && (
            <>
              <Box sx={userStyle.container}>
                ...
                <Grid container spacing={2} style={userStyle.dataTablestyle}>
                  ...
                  >
                    <Box>
                      {isUserRoleCompare?.includes("excelpaidlist") && (
                        <>
                          <Button
                            onClick={(e) => {
                      ...
                      {isUserRoleCompare?.includes("csvpaidlist") && (
                        <>
                          <Button
                            onClick={(e) => {
                              setIsFilterOpen(true);
                      ...
                      {isUserRoleCompare?.includes("printpaidlist") && (
                        <>
                          <Button
                            sx={userStyle.buttongrp}
                            onClick={handleprint}
                      ...
                      {isUserRoleCompare?.includes("pdfpaidlist") && (
                        <>
                          <Button
                            sx={userStyle.buttongrp}
                            onClick={() => {
                      ...
                      {isUserRoleCompare?.includes("imagepaidlist") && (
                        <>
                          <Button
                            sx={userStyle.buttongrp}
              ...
              <Grid container spacing={2}>
                ...
                <>
                  ...
                  <Grid item md={3} sm={12} xs={12} sx={{ display: "flex" }}>
                    ...
                    &emsp;
                    {/* <Button variant="contained" color="primary" type="button" sx={{ height: '30px', minWidth: '35px', marginTop: '28px', padding: '6px 10px' }}><FaPlus /></Button>&nbsp; */}
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                  ...
                  {/* <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput
                          readOnly
                          id="component-outlined"
                          value={singlePay.paymentfrequency}
                        />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12} sx={{ display: "flex" }}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput value={singlePay?.paid} readOnly />
                      </FormControl>
                      &emsp;
                    </Grid> */}
                </>
