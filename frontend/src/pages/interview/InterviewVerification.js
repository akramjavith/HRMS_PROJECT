...
function InterviewVerification() {
    ...
    const getCode = async (e) => {
        try {
            ...
            setEditDetails({
                ...
                informreason: response?.informreason || "",
                ...
                questionpreference: response?.questionpreference || "Default",
                questiondescription: response?.questiondescription || "",
                tamilquestion: response?.tamilquestion || "",
                tamilquestiondescription: response?.tamilquestiondescription || "",
            });
            handleClickOpenEdit();
        } catch (err) {
            handleApiError(err, setPopupContentMalert, setPopupSeverityMalert, handleClickOpenPopupMalert);
    ...
    const rowDataTable = filteredData?.map((item, index) => {
        return {
            ...
            questionpreference: item?.questionpreference,
            questiondescription: item?.questiondescription,
            informreason: item?.informreason,
            tamilquestion: item?.tamilquestion || "",
            tamilquestiondescription: item?.tamilquestiondescription || ""
        };
    });
    ...
    const editSubmit = (e) => {
        ...
        if (isNameMatch) {
            ...
            editDetails?.informreason === "" || !editDetails?.informreason) {
            setPopupContentMalert("Please Enter Inform Reason or Not Description!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
        }
        else if (
        ...
        // else if (
        //     editDetails?.tamilquestion?.trim() === "" || !editDetails?.tamilquestion
        // ) {
        //     setPopupContentMalert("Please Enter Verification Question in Tamil (சரிபார்ப்பு கேள்வி)!");
        //     setPopupSeverityMalert("info");
        //     handleClickOpenPopupMalert();
        // }
        else if (
            editDetails?.tamilquestion?.trim() !== "" && !hasTamilWord(editDetails?.tamilquestion)
        ) {
            setPopupContentMalert("Please Enter Atleast One Word in Tamil (சரிபார்ப்பு கேள்வி)!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
        }
        else if (
            editDetails?.tamilquestiondescription?.trim() !== "" && !hasTamilWord(editDetails?.tamilquestiondescription?.trim())
        ) {
            setPopupContentMalert("Please Enter Atleast One Word Tamil (கேள்வி விளக்கம்)!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
        }
        else if (
        ...
        // else if (
        //     optionstodoEdit?.some(item => item?.tamiloptions === "" || !item?.tamiloptions === "")
        // ) {
        //     setPopupContentMalert("Please Enter All Options in Tamil (சரிபார்ப்பு கேள்வி)!");
        //     setPopupSeverityMalert("info");
        //     handleClickOpenPopupMalert();
        // }
            ...
            optionstodoEdit?.some((item) => item?.description === "" || !item?.description)
        ) {
            setPopupContentMalert("Please Enter Description for All options!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
        }
        // else if (
        //     optionstodoEdit?.some((item) => item?.tamildescription === "" || !item?.tamildescription)
        // ) {
        //     setPopupContentMalert("Please Enter Description for All options in Tamil (விளக்கம்)!");
        //     setPopupSeverityMalert("info");
        //     handleClickOpenPopupMalert();
        // }

        else if (
            optionstodoEdit?.some(item => item?.tamiloptions?.trim() !== "" && !/[\u0B80-\u0BFF]+/.test(item.tamiloptions))
        ) {
            setPopupContentMalert("Please Enter Atleast One Word in Tamil (விருப்பங்கள்)!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
        }
        else if (
            optionstodoEdit?.some(item => item?.tamildescription?.trim() !== "" && !/[\u0B80-\u0BFF]+/.test(item.tamildescription))
        ) {
            setPopupContentMalert("Please Enter Atleast One Word in Tamil (விளக்கம்)!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
        }
        else {
        ...
        try {
            ...
            let res = await axios.post(
                `${SERVICE.CREATE_INTERVIEW_VERIFICATION}`,
                {
                    ...
                    informreason: filterState?.informreason?.trim() || "",
                    question: filterState?.question?.trim() || "",
                    tamilquestion: filterState?.tamilquestion?.trim() || "",
                    ...
                    questionpreference: filterState?.questionpreference || "Default",
                    questiondescription: filterState?.questiondescription || "",
                    tamilquestiondescription: filterState?.tamilquestiondescription || "",
                },
                {
                    headers: {
                        Authorization: `Bearer ${auth.APIToken}`,
        ...
        try {
            ...
            let res = await axios.put(
                `${SERVICE.SINGLE_INTERVIEW_VERIFICATION}/${editDetails?._id}`,
                {
                    ...
                    informreason: editDetails?.informreason || "",
                    question: editDetails?.question?.trim() || "",
                    tamilquestion: editDetails?.tamilquestion?.trim() || "",
                    optionsArray: optionstodoEdit,
                    questionpreference: editDetails?.questionpreference || "Default",
                    questiondescription: editDetails?.questiondescription || "",
                    tamilquestiondescription: editDetails?.tamilquestiondescription || "",
    ...
    const handleTodoEdit = (index, value, newValue) => {
        ...
        else if (value === "tamildescription") {
            updatedTodos[index].tamildescription = newValue;
        }
        else {
    ...
    const handleSubmit = () => {
        ...
        if (isNameMatch) {
            ...
            filterState?.informreason === "" || !filterState?.informreason) {
            setPopupContentMalert("Please Enter Inform Reason or Not Description!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
        }
        ...
        // else if (
        //     filterState?.tamilquestion?.trim() === "" || !filterState?.tamilquestion
        // ) {
        //     setPopupContentMalert("Please Enter Verification Question in Tamil (சரிபார்ப்பு கேள்வி)!");
        //     setPopupSeverityMalert("info");
        //     handleClickOpenPopupMalert();
        // }
            ...
            filterState?.tamilquestion?.trim() !== "" && !hasTamilWord(filterState?.tamilquestion?.trim())
        ) {
            setPopupContentMalert("Please Enter Atleast One Word Tamil (சரிபார்ப்பு கேள்வி)!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
        }
        else if (
            filterState?.tamilquestiondescription?.trim() !== "" && !hasTamilWord(filterState?.tamilquestiondescription?.trim())
        ) {
            setPopupContentMalert("Please Enter Atleast One Word Tamil (கேள்வி விளக்கம்)!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
            ...
            optionstodo?.some((item) => !item.description || item.description === "")
        ) {
            setPopupContentMalert("Please Enter Description for Every Options!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
        }
        // else if (
        //     optionstodo?.some((item) => !item?.tamildescription || item?.tamildescription === "")
        // ) {
        //     setPopupContentMalert("Please Enter Description for Every Options in Tamil(விருப்பங்கள்)!");
        //     setPopupSeverityMalert("info");
        //     handleClickOpenPopupMalert();
        // }
        else if (
            optionstodo?.some(item => item?.tamiloptions?.trim() !== "" && !/[\u0B80-\u0BFF]+/.test(item.tamiloptions))
        ) {
            setPopupContentMalert("Please Enter Atleast One Word for Every Options in Tamil(விருப்பங்கள்)!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
        }
        else if (
            optionstodo?.some(item => item?.tamildescription?.trim() !== "" && !/[\u0B80-\u0BFF]+/.test(item.tamildescription))
        ) {
            setPopupContentMalert("Please Enter Atleast One Word for Every Options in Tamil(விளக்கம்)!");
            setPopupSeverityMalert("info");
            handleClickOpenPopupMalert();
        }
        else {
                        ...
                        <>
                            <Grid container spacing={2}>
                                ...
                                <Grid item md={3} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        <Typography>
                                            Inform Reason or Not<b style={{ color: "red" }}>*</b>
                                        </Typography>
                                        <TextareaAutosize
                                            aria-label="minimum height"
                                            minRows={2.5}
                                            value={filterState?.informreason}
                                            onChange={(e) =>


                                                setFilterState((prev) => ({
                                                    ...prev,
                                                    informreason: e.target.value,
                                                }))
                                            }
                                        />
                                ...
                                <Grid item md={3} sm={12} xs={12}>
                                    <FormControl fullWidth size="small">
                                        <Typography>Question Preference</Typography>

                                        <Selects
                                            options={question_preference}
                                            value={{
                                                label: filterState?.questionpreference ? filterState?.questionpreference : "Please Select Question Preference",
                                                value: filterState?.questionpreference ? filterState?.questionpreference : "Please Select Question Preference",
                                            }}

                                            onChange={(e) => {
                                                setFilterState((prev) => ({
                                                    ...prev,
                                                    questionpreference: e.value,
                                                }))
                                            }}
                                        />
                                    </FormControl>
                                ...
                                <Grid item md={3} sm={12} xs={12}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <TextareaAutosize
                                            aria-label="minimum height"
                                            minRows={5}
                                            value={filterState?.questiondescription}
                                            onChange={(e) => {
                                                setFilterState((prev) => ({
                                                    ...prev,
                                ...
                                <Grid item md={9} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <TextareaAutosize
                                            aria-label="minimum height"
                                            minRows={5}
                                            value={filterState.tamilquestion}
                                            onChange={(e) => {
                                                // if (typingTest.questiontype === "Numeric") {
                                                //   const numericOnly = e.target.value.replace(
                                                //     /[^0-9.;\s]/g,
                                ...
                                <Grid item md={3} sm={12} xs={12}>
                                    <FormControl fullWidth size="small">
                                        <Typography>
                                            கேள்வி விளக்கம்</Typography>

                                        <TextareaAutosize
                                            aria-label="minimum height"
                                            minRows={5}
                                            value={filterState?.tamilquestiondescription}
                                            onChange={(e) => {
                                                const inputValue = e.target.value;
                                                // const tamilOnly = inputValue.replace(/[^\u0B80-\u0BFF0-9\s?.!,;:'"-]/g, "");
                                                const tamilOnly = inputValue;
                                                setFilterState((prev) => ({
                                                    ...prev,
                                                    tamilquestiondescription: tamilOnly,
                                                }))
                                            }}
                                        />
                                    </FormControl>
                ...
                <Box sx={{ padding: "20px 50px" }}>
                    <>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item md={4} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    <Typography variant="h6">Inform Reason or Not</Typography>
                                    <Typography>{viewDetails?.informreason || ""}</Typography>
                                </FormControl>
                            </Grid>
                            <Grid item md={4} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    <Typography variant="h6">Question Preference</Typography>
                                    <Typography>{viewDetails?.questionpreference || "Default"}</Typography>
                                </FormControl>
                            </Grid>
                            ...
                            <Grid item md={4} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    ...
                                    <Typography>{viewDetails?.questiondescription || ""}</Typography>
                                </FormControl>
                            </Grid>
                            <Grid item md={8} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    <Typography variant="h6">கேள்வி</Typography>
                                    <Typography>{viewDetails?.tamilquestion}</Typography>
                                </FormControl>
                            </Grid>
                            <Grid item md={4} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    <Typography variant="h6">கேள்வி விளக்கம்</Typography>
                                    <Typography>{viewDetails?.tamilquestiondescription || ""}</Typography>
                                </FormControl>
                            </Grid>
                            <Grid item md={12} xs={12} sm={12}>
                                                    ...
                                                    <Grid sx={{ display: "flex" }}>
                                                        ...
                                                        <FormControl fullWidth size="small">
                                                            ...
                                                            {/* <OutlinedInput
                                                                ...
                                                                readOnly
                                                            /> */}
                                                            <Typography>{item?.tamiloptions || ""}</Typography>
                                                        </FormControl>
                                                        &emsp;
                                                        <FormControl fullWidth size="small">
                                                            <Typography>
                                                        ...
                                                        <FormControl fullWidth size="small">
                                                            ...
                                                            <Typography>{item?.tamildescription || ""}</Typography>
                                                        </FormControl>
                                                    </Grid>
                                                </li>
                                            );
                    ...
                    <Box sx={{ padding: "20px 50px" }}>
                        <>
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <TextareaAutosize
                                            aria-label="minimum height"
                                            minRows={2.5}
                                            value={editDetails?.informreason}
                                            onChange={(e) =>
                                ...
                                <Grid item md={4} sm={12} xs={12}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <Selects
                                            options={question_preference}
                                            value={{
                                                label: editDetails?.questionpreference ? editDetails?.questionpreference : "Please Select Question Preference",
                                                value: editDetails?.questionpreference ? editDetails?.questionpreference : "Please Select Question Preference",
                                            }}
                                ...
                                <Grid item md={4} sm={12} xs={12}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <TextareaAutosize
                                            aria-label="minimum height"
                                            minRows={5}
                                            value={editDetails?.questiondescription}
                                            onChange={(e) => {
                                                setEditDetails((prev) => ({
                                                    ...prev,
                                                    questiondescription: e.target.value,
                                ...
                                <Grid item md={8} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <TextareaAutosize
                                            aria-label="minimum height"
                                            minRows={5}
                                            value={editDetails?.tamilquestion}
                                            onChange={(e) => {
                                                const inputValue = e.target.value;
                                                // const tamilOnly = inputValue.replace(/[^\u0B80-\u0BFF0-9\s?.!,;:'"-]/g, "");
                                                const tamilOnly = inputValue;
                                ...
                                <Grid item md={4} sm={12} xs={12}>
                                    <FormControl fullWidth size="small">
                                        <Typography>கேள்வி விளக்கம்</Typography>

                                        <TextareaAutosize
                                            aria-label="minimum height"
                                            minRows={5}
                                            value={editDetails?.tamilquestiondescription}
                                            onChange={(e) => {
                                                const inputValue = e.target.value;
                                                // const tamilOnly = inputValue.replace(/[^\u0B80-\u0BFF0-9\s?.!,;:'"-]/g, "");
                                                const tamilOnly = inputValue;
