...
function RaiseticketMaster() {
  ...
  const fetchCompany = (e) => {
    ...
    try {
      setCompanies(accessbranch?.map(data => ({
        label: data.company,
        value: data.company,
  ...
  const sendRequestRaise = async () => {
    ...
    try {
      ...
      formData.append('employeename',
        Access === "Manager" ? JSON.stringify(selectedOptionsEmployeesValues) : isUserRoleAccess.companyname
      );
      formData.append('accessEmp',
        String(Access === "Manager" && raiseTicketMaster.employeename === "ALL")
      );
      formData.append('employeecode',
        Access === "Manager" ? JSON.stringify(selectedOptionsEmployeesID) : isUserRoleAccess.empcode
      );
      ...
      formData.append('subsubcategory',
        String(raiseTicketMaster.subsubcategory) === "Please Select Sub Sub-category" ? "" : String(raiseTicketMaster.subsubcategory)
      );
      formData.append('type', String(typemaster || "No Type"));
      formData.append('reason',
        String(raiseTicketMaster.reason) === "Please Select Reason" ? "No Specific Reason" : String(raiseTicketMaster.reason)
      );
      ...
      formData.append('workstation',
        raiseTicketMaster.workstation === "Please Select Work Station" ? "" : raiseTicketMaster.workstation
      );
      formData.append('materialname',
        raiseTicketMaster.materialname === "Please Select Material Name"
          ? "Please Select Material Name"
          : raiseTicketMaster.materialname
      );
      formData.append('materialcode',
        raiseTicketMaster.materialname === "Please Select Material Name" ? "" : assetMaterialCode
      );
      formData.append('materialnamecut',
        raiseTicketMaster.materialname === "Please Select Material Name" ? "" : raiseTicketMaster.materialname?.split("-")[0]
      );
  ...
  return (
    <>
      <Box>
        ...
        <PageHeading
          title="Raise Ticket Master"
          modulename="Tickets"
          submodulename="Raise Ticket"
          mainpagename="Raise Ticket"
          subpagename=""
          subsubpagename=""
        />
        <Grid>
