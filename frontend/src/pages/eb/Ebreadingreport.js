...
function EBReadingDetailsList() {
  ...
  const handleCaptureImage = () => {
    if (gridRefTableImg.current) {
      domtoimage.toBlob(gridRefTableImg.current)
        .then((blob) => {
          saveAs(blob, "EB Reading Report .png");
        })
        .catch((error) => {
  ...
  const handleprint = useReactToPrint({
    ...
    documentTitle: "EB Reading Report",
    pageStyle: "print",
  });
  ...
  const getapi = async () => {
    let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
      ...
      pagename: String("Eb Reading Report"),
  ...
  return (
    <Box>
      <Headtitle title={"EB Reading Report"} />
      {/* ****** Header Content ****** */}
      {/* <Typography sx={userStyle.HeaderText}>
        Manage EB Reading Report
      </Typography> */}
      <PageHeading
        title=" Manage EB Reading Report"
        modulename="EB"
        submodulename="EB Reading Report"
        mainpagename=""
        subpagename=""
        subsubpagename=""
      />
                ...
                <Grid item md={3} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    ...
                    >
                      ...
                      <MenuItem value="Bill Closing">
                        {" "}
                        {"Bill Closing"}{" "}
                      </MenuItem>
                      <MenuItem value="Session Closing">
                        {" "}
                        {"Session Closing"}{" "}
                      </MenuItem>
        ...
        <>
          <Box sx={userStyle.container}>
            ...
            <Grid container spacing={2} style={userStyle.dataTablestyle}>
              ...
              >
                <Box>
                  {isUserRoleCompare?.includes("excelebreadingreport") && (
                    <>
                      <Button
                        onClick={(e) => {
                  ...
                  {isUserRoleCompare?.includes("csvebreadingreport") && (
                    <>
                      <Button
                        onClick={(e) => {
                          setIsFilterOpen(true);
                  ...
                  {isUserRoleCompare?.includes("printebreadingreport") && (
                    <>
                  ...
                  {isUserRoleCompare?.includes("pdfebreadingreport") && (
                    <>
                      <Button
                        sx={userStyle.buttongrp}
                        onClick={() => {
                  ...
                  {isUserRoleCompare?.includes("imageebreadingreport") && (
                    <Button
                      sx={userStyle.buttongrp}
