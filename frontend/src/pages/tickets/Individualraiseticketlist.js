...
import { TextField, IconButton, ListItem, RadioGroup, List, TextareaAutosize, Radio, FormControlLabel, Checkbox, InputAdornment, ListItemText, Tooltip, Popover, Box, Typography, OutlinedInput, TableBody, Select, Paper, MenuItem, Dialog, DialogContent, DialogActions, FormControl, Grid, Table, TableHead, TableContainer, Button } from "@mui/material";
...
function Individualaiseticketist() {
  ...
  const handleFilterTickets = async () => {
    ...
    const allFilters = [
      ...additionalFilters,
      {
        column: selectedColumn === "status" ? "raiseself" :
          selectedColumn === "reason" ? "textAreaCloseDetails" :
            selectedColumn, condition: selectedCondition, value: filterValue
      }
    ];
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading
        title="Individual Raise Ticket List"
        modulename="Tickets"
        submodulename="Raise Ticket"
        mainpagename="Individual Ticket List"
        subpagename=""
        subsubpagename=""
      />
      <>
            ...
            <>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item md={6} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    <Typography sx={userStyle.HeaderText}><b>Employee Name</b></Typography>
                    <Typography>{singleDoc?.employeename?.map((t, i) => `${i + 1 + ". "}` + t).toString()}</Typography>
                  </FormControl>
                </Grid>
                <Grid item md={3} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    <Typography sx={userStyle.HeaderText}><b>Employee Code</b></Typography>
                    <Typography>{singleDoc?.employeecode?.map((t, i) => `${i + 1 + ". "}` + t).toString()}</Typography>
                  </FormControl>
                </Grid>
                <Grid item md={3} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    <Typography sx={userStyle.HeaderText}><b>Ticket Number</b></Typography>
                ...
                <Grid item md={4} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    <Typography sx={userStyle.HeaderText}>
                      <b>Change Ticket Status<b style={{ color: "red" }}>*</b></b>
                    </Typography>
                    <Selects
