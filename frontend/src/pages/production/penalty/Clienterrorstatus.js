...
function ClientErrorStatus() {
    ...
    let exportColumnNames = ['Vendor Name','Branch Name','Employee Code','Employee Name','Login Id','Date','Category','Subcategory','Document Number','Filed Name','Line','Error Value','Correct Value','Client Value','Client Amount','Reason'];
    let exportRowValues = ['vendorname','branchname','employeecode','employeename','loginid','date','category','subcategory','documentnumber','filedname','line','errorvalue','correctvalue','clienterror','clientamount','reason'];
    ...
    const [allClientEdit, setAllClientEdit] = useState([]);
    ...
    const fetchAllClient = async () => {
        ...
        try {
            ...
            setClients(res_grp?.data?.groups.map((item, index) => ({
                ...item,
    ...
    const columnDataTable = [
        ...
        },
        {
            ...
            flex: 0,
            width: 100,
            hide: !columnVisibility.filedname,
            headerClassName: "bold-header",
        },
        {
            field: "line",
...

        {
            ...
            cellRenderer: (params) => (
                <Grid sx={{ display: "flex" }}>
                    {isUserRoleCompare?.includes("eclienterrorstatus") && (
                        <Button
                    ...
                    {isUserRoleCompare?.includes("dclienterrorstatus") && (
                        <Button
                    ...
                    {isUserRoleCompare?.includes("vclienterrorstatus") && (
                        <Button
                            sx={userStyle.buttonedit}
                            onClick={() => {
                    ...
                    {isUserRoleCompare?.includes("iclienterrorstatus") && (
                        <Button
                            sx={userStyle.buttonedit}
                            onClick={() => {
    ...
    return (
        <Box>
            ...
            <PageHeading
                ...
                subsubpagename="Client Error Status"
            />
            {isUserRoleCompare?.includes("aclienterrorstatus") && (
                <>
            ...
            {isUserRoleCompare?.includes("lclienterrorstatus") && (
                ...
                <>
                    <Box sx={userStyle.container}>
                            ...
                            <Grid item md={2} xs={12} sm={12}>
                                <Box>
                                    ...
                                    >
                                        ...
                                        <MenuItem value={clients?.length}>All</MenuItem>
                                    </Select>
                                </Box>
                            </Grid>
                            <Grid
                        ...
                        &ensp;
                        {isUserRoleCompare?.includes("bdclienterrorstatus") && (
                            <Button
                                variant="contained"
            ...
            >
                <Box sx={{ width: "550px", padding: "20px 50px" }}>
                    <>
                        <Typography sx={userStyle.HeaderText}> View Client Error Status</Typography>
                        <br /> <br />
                        <Grid container spacing={2}>
                            <Grid item md={12} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
            ...
            <InfoPopup
                ...
                heading="Client Error Status Info"
                addedby={addedby}
                updateby={updateby}
            />
