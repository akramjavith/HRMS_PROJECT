...
function IndividualInternalstatusList() {
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("Employee Individual Internal Status List"),
    ...
    const fetchVendorDropdowns = async (e) => {
        ...
        try {
            ...
            let filteredDatas = res?.data?.vendormaster?.filter((data) => {
                return data?.projectname === e.value
    ...
    const handleSubmission = async () => {
        ...
        try {
            ...
            let request = await axios.post(SERVICE.ACHIEVEDACCURACYINDIVIDUALFILTER, {
                ...
                fromWhere: "Internal",
                project: selectedProject && selectedProject !== "Please Select Project" ? selectedProject : "",
                vendor: selectedVendor && selectedVendor !== "Please Select Vendor" ? selectedVendor : "",
                queue: selectedQueue && selectedQueue !== "Please Select Queue" ? selectedQueue : "",
            });
            ...
            const itemsWithSerialNumber = [...request?.data?.filteredData]?.map((item, index) => ({
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "Employee Individual Internal Status List.png");
                })
                .catch((error) => {
    ...
    const downloadPdf = (isfilter) => {
        ...
        doc.save("Employee Individual Internal Status List.pdf");
    };
    // Excel
    const fileName = "Employee Individual Internal Status List";
    //print...
    const componentRef = useRef();
    const handleprint = useReactToPrint({
        content: () => componentRef.current,
        documentTitle: "Employee Individual Internal Status List",
        pageStyle: "print",
    });
    useEffect(() => {
        ...
        { field: "autoerrorcount", headerName: "Auto Error Count", flex: 0, width: 180, hide: !columnVisibility.autoerrorcount, headerClassName: "bold-header" },
        {
            ...
            cellRenderer: (params) => (
                <Grid sx={{ display: 'flex' }}>
                    {isUserRoleCompare?.includes("vindividualemployeeinternalstatuslist") && (
                        <Button
    ...
    return (
        <Box>
            {/* ****** Header Content ****** */}
            <Headtitle title={"Employee Individual Internal Status List"} />
            <PageHeading
                title="Employee Individual Internal Status List"
                modulename="Quality"
                submodulename="Accuracy"
                mainpagename="Employee Individual Internal Status List"
                subpagename=""
                subsubpagename=""
            />
            ...
            <br />
            {isUserRoleCompare?.includes("lindividualemployeeinternalstatuslist") && (
                <>
                    <Box sx={userStyle.selectcontainer}>
                        <Grid container spacing={2}>
                            <>
                                ...
                                <Grid item md={4} sm={6} lg={2} xs={12} mt={2} sx={{ display: 'flex',justifyContent:'center',alignItems:'center',gap:'20px' }}>
                    ...
                    <Box sx={userStyle.container}>
                        { /* ******************************************************EXPORT Buttons****************************************************** */}
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>Employee Individual Internal Status List</Typography>
                        </Grid>
                        <Grid container spacing={2} style={userStyle.dataTablestyle}>
                            ...
                            <Grid item md={6} xs={12} sm={12} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                <Box >
                                    {isUserRoleCompare?.includes("excelindividualemployeeinternalstatuslist") && (
                                        <>
                                            <Button onClick={(e) => {
                                    ...
                                    {isUserRoleCompare?.includes("csvindividualemployeeinternalstatuslist") && (
                                        <>
                                            <Button onClick={(e) => {
                                                setIsFilterOpen(true)
                                                // fetchAchievedAccuracyIndividualArray()
                                    ...
                                    {isUserRoleCompare?.includes("printindividualemployeeinternalstatuslist") && (
                                        <>
                                            <Button sx={userStyle.buttongrp} onClick={handleprint}>&ensp;<FaPrint />&ensp;Print&ensp;</Button>
                                        </>
                                    )}
                                    {isUserRoleCompare?.includes("pdfindividualemployeeinternalstatuslist") && (
                                        <>
                                    ...
                                    {isUserRoleCompare?.includes("imageindividualemployeeinternalstatuslist") && (
            ...
            >
                <Box sx={{ padding: '20px 50px' }}>
                    <>
                        <Typography sx={userStyle.HeaderText}>View Employee Individual Internal Status List</Typography>
                        <br /><br />
                        <Grid container spacing={2}>
                            <Grid item md={4} xs={12} sm={12} >
                                <FormControl fullWidth size="small" >
            ...
            <ExportData
                ...
                itemsTwo={employees ?? []}
                filename={"Employee Individual Internal Status List"}
...
export default IndividualInternalstatusList;