  ...
  const handleSubmit = async (e) => {
    ...
    if (CheckDup) {
      ...
      (addcandidate.experience != "" &&
        ...
        addcandidate.currentsalary == "" && addcandidate.experienceoption !== "Not Working") ||
      0
    ) {
      ...
      (addcandidate.experience != "" &&
        addcandidate.experience > 0 &&
        addcandidate.noticeperiod == 0 && addcandidate.experienceoption !== "Not Working") ||
      0
    ) {
