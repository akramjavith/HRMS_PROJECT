...
function VisitorDetailsLogList() {
    ...
    const visitorDetailsLog = async () => {
        ...
        try {
            ...
            setTaskcategorys(res?.data?.svisitordetailslog?.map((item, index) => {
            ...
            renderCell: (params) => (
                <Grid sx={{ display: 'flex' }}>
                    {isUserRoleCompare?.includes("vvisitorsdetailslog") && (
                        ...
                        <Button sx={userStyle.buttonedit} style={{ minWidth: "0px" }} onClick={() => {
    ...
    return (
        <Box>
            ...
            <PageHeading
                title="Visitor Details Log List"
                modulename="Interactors"
                submodulename="Visitor"
                mainpagename="Visitors Details Log List"
                subpagename=""
                subsubpagename=""
            />
