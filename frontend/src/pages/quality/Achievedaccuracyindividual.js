    ...
    const readExcel = (file, name, e) => {
        if (
            ...
            promise.then((d) => {
                ...
                let isTrue = dayPointsUploadOverallData.some(
                    (item) => item.date === acheivedAccuracyDetails.date &&
                ...
                const ans = [
                    {
                        ...
                        vendor: acheivedAccuracyDetails.vendor,
                        queue: acheivedAccuracyDetails.queue,
                        uploaddata: isTrue ? dataArray : filteredArray2time,
                ...
                setShow(true);
                setAlertButton(true);
                setDataArrayLength(isTrue ? dataArray.length : filteredArray2time.length);
                setLoading(false);
            });
        }
    };
                ...
                isUserRoleCompare?.includes("lacheivedaccuracyindividual") && (
                    <>
                        <Box sx={userStyle.container}>
                            {/* ******************************************************EXPORT Buttons****************************************************** */}
                            <Grid item xs={8}>
                                <Typography sx={userStyle.importheadtext} onClick={() => { console.log(dayPointsUploadOverallData); }}>List Achieved Accuracy Individual</Typography>
                            </Grid>
