...
const { addClientUserID, deleteClientUserID, getAllClientUserCheck, clientUseridsReportIdsOnly, updateLoginAllotLogValues, deleteLoginAllotLog,
  ...
  getLoginAllotidDetails, getAllClientUserID, getAllClientUserIDLimited,clientUserIdLimitedValidatonErrorEntry,
...
productionRoute.route("/clientuseridvalidatonerrorentry").post(clientUserIdLimitedValidatonErrorEntry);
...
const { getAllPenaltytotalfieldupload, updatePenaltytotalfieldupload, deletePenaltytotalfieldupload, getPenaltyTotalFieldLoginProject,
  getAllPenaltytotalfielduploadFilter, deleteMultiplePenaltytotalfieldupload, getSinglePenaltytotalfieldupload,getAllPenaltytotalfielduploadViewAllUploadFile,
  getAllErrorUploadHierarchyList, getAllValidationErrorFilter,getAllValidationErrorFilterStatusCompleted, getAllPenaltytotalfielduploadValidationEntry,getAllErrorUploadHierarchyListCompleted,
  ...
  addPenaltytotalfieldupload, getAllPenaltytotalfielduploadInvalidReject, getAllValidOkEntryAlert,getAllErrorUploadConfirmUserList,
  getAllInvalidValidOverallReport,getAllValidOverallReport
 } = require("../controller/modules/penalty/penaltytotalfieldupload");
productionRoute.route("/penaltytotalfielduploads").get(getAllPenaltytotalfieldupload);
productionRoute.route("/invalidvalidoverallreport").post(getAllInvalidValidOverallReport);
productionRoute.route("/validoverallreport").post(getAllValidOverallReport);
productionRoute.route("/penaltytotalfielduploadsviewuploadfile").post(getAllPenaltytotalfielduploadViewAllUploadFile);
...
productionRoute.route("/erroruploadconfirmuserlist").post(getAllErrorUploadConfirmUserList);
productionRoute.route("/erroruploadconfirmhierarchylistcompleted").post(getAllErrorUploadHierarchyListCompleted);
productionRoute.route("/validationerrorfilters").post(getAllValidationErrorFilter);
productionRoute.route("/validationerrorfiltersstatuscompleted").post(getAllValidationErrorFilterStatusCompleted);
...
const { getAllIdletimework, getSingleIdletimework, updateIdletimework, addIdletimework, deleteIdletimework,getAllIdletimeworkemployee,
  getAllIdletimeworkStatusListReport,getAllIdletimeworkStatusListIndividualReport,
  getAllIdletimeworkCheckListReport,getAllIdletimeworkCheckListReportApproveReject,getAllIdletimeworkCheckListReportViewWaitForApprove,getAllIdleTimeWorkApproveUpdate} = require("../controller/modules/production/idletimework");
...
productionRoute.route("/idletimeworkchecklistreportviewwaitforapprove").post(getAllIdletimeworkCheckListReportViewWaitForApprove);
productionRoute.route("/idletimeworkapprovedupdate").post(getAllIdleTimeWorkApproveUpdate);
productionRoute.route("/idletimeworkstatusreportlist").post(getAllIdletimeworkStatusListReport);
productionRoute.route("/idletimeworkstatusreportindividuallist").post(getAllIdletimeworkStatusListIndividualReport);
