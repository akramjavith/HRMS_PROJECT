  ...
  const sendRequest = async () => {
    ...
    try {
      ...
      const jsonData = {
        ...
        // pcountry: String(selectedCountry.name),
        // pstate: String(selectedState.name),
        // pcity: String(selectedCity.name),
        ...
        faceDescriptor:
          addcandidateEdit?.faceDescriptor?.length > 0
            ...
            : [],
        uploadedimage: addcandidateEdit.uploadedimage ? String(addcandidateEdit.uploadedimage) : "",
