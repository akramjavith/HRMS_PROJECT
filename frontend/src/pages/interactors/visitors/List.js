...
const ScrollingText = ({ text }) => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={containerRef}
        style={{ overflow: "hidden", width: "30%", whiteSpace: "nowrap" }}
      >
        ...
        <Grid sx={{ display: "flex" }}>
          ...
          {isUserRoleCompare?.includes("vlistvisitors") && (
            ...
            >
              ...
              }} variant="contained" style={{ fontWeight: "50px" }} disabled={params.data.interactorstatus === "addresume"}>Linked Datas
              </Button>
            </Link>
          )}
          {/* } */}
          {isUserRoleCompare?.includes("elistvisitors") && (
            <Link
              to={`/interactor/master/editvisitors/${params.data.id}/list/?status=${params.data.interactorstatus}`}
          ...
          {isUserRoleCompare?.includes("vlistvisitors") && (
            <Link
              to={`/interactor/master/viewvisitors/${params.data.id}/list/?status=${params.data.interactorstatus}`}
              style={{ textDecoration: "none", color: "#fff", minWidth: "0px" }}
            >
              <Button sx={userStyle.buttonedit} style={{ minWidth: "0px" }}>
          ...
          {isUserRoleCompare?.includes("vlistvisitors") && (
            <Link
              to={`/interactor/master/followupvisitor/${params.data.id}/list/?status=${params.data.interactorstatus}`}
              style={{ textDecoration: "none", color: "#fff", minWidth: "0px" }}
            >
              <Button sx={userStyle.buttonedit} style={{ minWidth: "0px" }}>
