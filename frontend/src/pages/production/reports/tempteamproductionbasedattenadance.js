...
function TempTeamProductionBasedAttendance() {
    ...
    let listpageaccessby =
        listPageAccessMode?.find(
            (data) =>
                ...
                data.subpagename === "Team Production Base Attendance" &&
                data.subsubpagename === ""
    ...
    let res= await axios.post(
                SERVICE.TEMP_HIERARCHY_TEAM_ATTENDANCE_BASED_CLAIM,
                {
                    headers: {
                    ...
                    pagename: "menutempteamproductionbaseattendance",
                    listpageaccessmode: listpageaccessby,
                }
            );
            if(res.statusText === "OK"){
            let res_employee = await axios.post(
                SERVICE.TEMP_TEAM_ATTENDANCE_BASED_CLAIM,
                {
                    headers: {
                        Authorization: `Bearer ${auth.APIToken}`,
                    },
                    ...
                    hierachy: modeselection.value,
                    sector: sectorSelection.value,
                      names:res.data.resultAccessFilter,
  ...
  if(res_employee.data.isDayPointsCreated  === 0){
...
setisuser([])
    ...
    const HandleTablesubmit = (e) => {
     ...
     if (modeselection.value === "Please Select Mode") {
          ...
          else  if (productionbasedattendance.date === "") {
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("Team Production Base Attendance"),
    ...
    return (
        <Box>
            <Headtitle title={"Team Production Base Attendance"} />
            {/* ****** Header Content ****** */}
            <PageHeading
                title="Team Production Base Attendance Filter"
                modulename="Production"
                submodulename="Manual Entry"
                mainpagename="Team Production Base Attendance Filter"
                subpagename=""
                subsubpagename=""
            />
            <Box>
                ...
                <Box sx={userStyle.dialogbox}>
                    <>
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>Team Production Base Attendance Filter List</Typography>
                        </Grid>
                            ...
                            >
                                <Box>
                                    {isUserRoleCompare?.includes(
                                        "exceltempteamproductionbaseattendance"
                                    ) && (
                                            <>
                                                <Button
                                                    onClick={(e) => {
                                    ...
                                    {isUserRoleCompare?.includes(
                                        "csvtempteamproductionbaseattendance"
                                    ) && (
                                            <>
                                                <Button
                                                    onClick={(e) => {
                                    ...
                                    {isUserRoleCompare?.includes(
                                        "printtempteamproductionbaseattendance"
                                    ) && (
                                            <>
                                    ...
                                    {isUserRoleCompare?.includes(
                                        "pdftempteamproductionbaseattendance"
                                    ) && (
                                            <>
                                                <Button
                                                    sx={userStyle.buttongrp}
                                    ...
                                    {isUserRoleCompare?.includes(
                                        "imagetempteamproductionbaseattendance"
                                    ) && (
                                            <Button
                                                sx={userStyle.buttongrp}
...
export default TempTeamProductionBasedAttendance;