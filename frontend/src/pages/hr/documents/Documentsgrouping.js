...
function DocumentGrouping() {
    ...
    const getCode = async (e, name) => {
        ...
        try {
            ...
            setSelectedOptionsCateEdit(res?.data?.sdocumentgrouping.document.map((item) => ({
                ...item,
                label: item,
                value: item,
            })))
    ...
    const fetchDocumentGrouping = async () => {
        ...
        } catch (err) { setDocumentgroupingcheck(true); handleApiError(err, setPopupContentMalert, setPopupSeverityMalert, handleClickOpenPopupMalert); }
    }
                                    ...
                                    <Grid item md={4} sm={12} xs={12} sx={{ display: "flex" }}>
                                        <FormControl fullWidth size="small">
                                            ...
                                            <MultiSelect
                                                ...
                                                labelledBy="Please Select Documents"
                                            />
                                        </FormControl>
                                    </Grid>
                                </Grid>
