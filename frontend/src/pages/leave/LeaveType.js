...
import {
    ...
    TableContainer, Button, List, ListItem, ListItemText, Popover, Checkbox, TextField, IconButton, TextareaAutosize
} from "@mui/material";
...
function Leavetype() {
    ...
    const delSource = async (e) => {
        ...
        try {
            if (Sourcesid) {
                await axios.delete(`${SERVICE.LEAVETYPE_SINGLE}/${e}`, {
                    headers: {
                        'Authorization': `Bearer ${auth.APIToken}`
                    }
                });
    ...
    const downloadPdf = (isfilter) => {
        ...
        const dataWithSerial = isfilter === "filtered" ?
            ...
            leaveTypeData.map(row => ({ ...row, serialNumber: serialNumberCounter++ }));
    ...
    return (
        <Box>
            ...
            {/* ****** Header Content ****** */}
            <Typography sx={userStyle.HeaderText}>Manage Leave Type</Typography>
                        ...
                        <Box sx={userStyle.dialogbox}>
                            <>
                                ...
                                <Grid item md={12} xs={12} sm={12}>
                                    <Grid sx={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center" }} gap={2}>
            ...
            <Box>
                ...
                >
                    <Box sx={{ width: '550px', padding: '20px 50px' }}>
                        <>
                            <Typography sx={userStyle.HeaderText}>Leave Type Info</Typography>
                            <br /><br />
                            <Grid container spacing={2}>
                                <Grid item md={12} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
