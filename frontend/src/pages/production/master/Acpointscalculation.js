...
function AcPointCalculation() {
  ...
  const handleSubmit = (e) => {
    ...
    const isNameMatch = acPointCalculation.some(
      (item) => item.company === acpointcalculationState.company && item.branch === acpointcalculationState.branch && valueDepartmentCat.includes(item.department) && item.dividevalue === acpointcalculationState.dividevalue && item.multiplevalue === acpointcalculationState.multiplevalue
    );
  ...
  const editSubmit = async (e) => {
    ...
    const isNameMatch = resdata.some((item) => item.company === sourceEdit.company && item.branch === sourceEdit.branch && item.department === sourceEdit.department && item.dividevalue === sourceEdit.dividevalue && item.multiplevalue === sourceEdit.multiplevalue);
  ...
  const fetchAcpointcalculation = async () => {
    ...
    try {
      let res_vendor = await axios.post(
        SERVICE.ACPOINTCALCULATIONASSIGNBRANCH,
        {
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading title="AC-Point Calculation" modulename="Production" submodulename="SetUp" mainpagename="Ac-Point Calculation" subpagename="" subsubpagename="" />
            ...
            <>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item md={3} xs={12} sm={6}>
                  <FormControl fullWidth size="small">
                    ...
                    <Selects
                      maxMenuHeight={300}
                      options={accessbranch
                        ?.filter((comp) => acpointcalculationState.company === comp.company)
                        ?.map((data) => ({
                          label: data.branch,
                          value: data.branch,
                        }))
                ...
                <Grid item md={3} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    <Typography>
                      Divide Value <b style={{ color: 'red' }}>*</b>
                    </Typography>
                    <OutlinedInput
                ...
                <Grid item md={3} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    <Typography>
                      Multiple Value <b style={{ color: 'red' }}>*</b>
                    </Typography>
                    <OutlinedInput
                      id="component-outlined"
                      type="text"
                  ...
                  <Grid item md={4} xs={12} sm={6}>
                    <FormControl fullWidth size="small">
                      ...
                      <Selects
                        maxMenuHeight={300}
                        options={accessbranch
                          ?.filter((comp) => sourceEdit.company === comp.company)
                          ?.map((data) => ({
                            label: data.branch,
                            value: data.branch,
                          }))
      ...
      />
      {/* INFO */}
      <InfoPopup openInfo={openInfo} handleCloseinfo={handleCloseinfo} heading="AC-Point Calculation Info" addedby={addedby} updateby={updateby} />
