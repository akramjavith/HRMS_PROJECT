...
function DesktopLoginReport() {
  ...
  let exportColumnNames = usernameChecked ?
    ['Company', 'Branch', 'Unit', 'Department', 'Team', 'Work Mode', 'Emp Code', 'Name', 'Username', 'Login', 'Logoff', 'Locked', 'Unlocked', 'Sleep', 'Wake', "Logon",
  ...
  let exportRowValues = usernameChecked ?
    ['company', 'branch', 'unit', 'department', 'team', 'workmode', 'empcode', 'employeename', 'username', 'login', 'logoff', 'locked', 'unlocked', 'sleep', 'wake',
      "logon",
      "failedlogonattempt",
      "userinitiatedlogoff",
