...
function ProductionSalaryList() {
        ...
        if (res.data.users.length > 0) {
          ...
          getAllResults().then(results => {
            ...
            function processEmployeeItem(item, index, data) {
              ...
              let PROD_TaxCalcVal = CHECK_DEPARTMENT_ACCESS && CHECK_DEPARTMENT_ACCESS.target === false ? 0 : findprofTaxAmt ? Number(findprofTaxAmt.taxamount) : 0;
              ...
              let totalPointsValueCalc = (CHECK_DEPARTMENT_ACCESS && CHECK_DEPARTMENT_ACCESS.target === true && AcheivedPointsCalcVal) ?
                ((Number(AcheivedPointsCalcVal) / Dvalue) * Mvalue ? (Number(AcheivedPointsCalcVal) / Dvalue) * Mvalue : 0) : 0;
              ...
              PROD_TaxCalcVal = CHECK_DEPARTMENT_ACCESS && CHECK_DEPARTMENT_ACCESS.target === false ? 0 : findprofTaxAmt ? Number(findprofTaxAmt.taxamount) : 0;
  ...
  const columns = [
    ...
    { title: "PROD Loss Deduction", dataKey: "prodlossdeduction" },
    { title: "PROD Net Salary", dataKey: "prodnetsalary" },
    { title: "PROD Basic", dataKey: "prodbasicp" },
    { title: "PROD HRA", dataKey: "prodhrap" },
    { title: "PROD Conveyance", dataKey: "prodconveyancep" },
    { title: "PROD Medical Allowance", dataKey: "prodmedicalallowancep" },
    { title: "PROD Production Allowance", dataKey: "prodproductionallowancep" },
    { title: "PROD Other Allowance", dataKey: "prodotherallowancep" },
    { title: "PROD Net Salary1", dataKey: "prodnetsalaryonep" },

    { title: "PROD_Emp_pf", dataKey: "prodemppf" },
    { title: "PROD_Emp_esi", dataKey: "prodempesi" },
    { title: "PROD_Emp_ptax", dataKey: "prodempptax" },
    { title: "PROD_Empr_pf", dataKey: "prodemprpf" },
    { title: "PROD_Empr_Esi", dataKey: "prodempresi" },
    { title: "PROD Shift Allowance", dataKey: "prodshiftallowance" },
    { title: "PROD Total Deductions", dataKey: "prodtotaldeductions" },

    { title: "PROD Salary", dataKey: "prodsalary" },
    { title: "PROD Salary-Penalty", dataKey: "prodsalarypenalty" },
    { title: "PROD LOP Days", dataKey: "prodlopdays" },
    { title: "PROD LOP ", dataKey: "prodlop" },
    { title: "PROD leave Deduction", dataKey: "prodleavededuction" },

    { title: "PROD CTC", dataKey: "prodctc" },
    { title: "PROD Final Value", dataKey: "prodfinalvalue" },

    { title: "PROD Actual Deduction", dataKey: "prodactualdeduction" },
    { title: "PROD Minimum Deduction", dataKey: "prodminimumdeduction" },
