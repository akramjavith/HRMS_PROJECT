...
function Editpage() {
  ...
  let exportColumnNames = ['EmpCode', 'Name', 'Branch', 'DOT', 'DOJ', "Work Mode"];
  let exportRowValues = ['empcode', 'companyname', 'branch', 'dot', 'doj', 'workmode'];
  ...
  const [joingupdatecheck, setjoingupdatecheck] = useState(false);
  ...
  const getapi = async () => {
    let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
      ...
      pagename: String("Joining Update"),
  ...
  const handleCaptureImage = () => {
    if (gridRefTableImg.current) {
      domtoimage.toBlob(gridRefTableImg.current)
        .then((blob) => {
          saveAs(blob, "Joining Update.png");
        })
        .catch((error) => {
  ...
  //joiningupdate updateby edit page...
  ...
  const editSubmit = (e) => {
    e.preventDefault();
    if (empaddform?.doj == "" || empaddform?.doj == undefined) {
      setPopupContentMalert('Please fill DOJ!');
  ...
  const handleExportXL = (isfilter) => {
    ...
    exportToExcel(formatData(dataToExport), "Joiningupdate");
    setIsFilterOpen(false);
  };
          ...
          {isUserRoleCompare.includes("Manager") ? (
            <>
              <Grid container spacing={2}>
                <Grid item>
                  {isUserRoleCompare?.includes("ijoininginfoupdate") && (
                    <>
                      <Button
            ...
            <>
              <Grid sx={{ display: "flex" }}>
                {isUserRoleCompare?.includes("ejoininginfoupdate") && (
                  <Button
                    sx={userStyle.buttonedit}
                    onClick={() => {
  ...
  return (
    <Box>
      ...
      <Headtitle title={"JOINING INFO UPDATE"} />
      ...
      <PageHeading
        ...
        subsubpagename="Joining Info update"
      />
      <br />
      {isUserRoleCompare?.includes("ljoininginfoupdate") && (
        <>
        ...
        <>
          <Box sx={userStyle.container}>
            ...
            <Grid container spacing={2} style={userStyle.dataTablestyle}>
              ...
              >
                <Box>
                  {isUserRoleCompare?.includes("exceljoininginfoupdate") && (
                    <>
                      <Button
                        onClick={(e) => {
                  ...
                  {isUserRoleCompare?.includes("csvjoininginfoupdate") && (
                    <>
                      <Button
                        onClick={(e) => {
                          setIsFilterOpen(true);
                  ...
                  {isUserRoleCompare?.includes("printjoininginfoupdate") && (
                    <>
                  ...
                  {isUserRoleCompare?.includes("pdfjoininginfoupdate") && (
                    <>
                      <Button
                        sx={userStyle.buttongrp}
                        onClick={() => {
                  ...
                  {isUserRoleCompare?.includes("imagejoininginfoupdate") && (
                    <Button
                      sx={userStyle.buttongrp}
      ...
      >
        <Box sx={{ width: "550px", padding: "20px 50px" }}>
          <>
            <Typography sx={userStyle.HeaderText}> Joining Info</Typography>
            <br />
            <br />
            <Grid container spacing={2}>
